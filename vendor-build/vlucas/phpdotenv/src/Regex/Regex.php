...
namespace ExpressionEngine\Dependency\Dotenv\Regex;

use ExpressionEngine\Dependency\Dotenv\Result\Error;
use ExpressionEngine\Dependency\Dotenv\Result\Result;
use ExpressionEngine\Dependency\Dotenv\Result\Success;
class Regex
{
    /**
