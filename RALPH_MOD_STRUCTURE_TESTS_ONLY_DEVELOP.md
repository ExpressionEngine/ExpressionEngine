...
- [in progress] Add high-value pre-refactor PHPUnit tests for TARGET_METHOD=get_site_pages_query in system/ee/ExpressionEngine/Addons/structure/mod.structure.php (develop baseline) without production code changes. <!-- ralph:id=structure-mod-tests-029 -->
