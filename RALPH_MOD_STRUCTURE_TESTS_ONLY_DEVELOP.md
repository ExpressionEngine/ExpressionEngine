...
- [in progress] Add high-value pre-refactor PHPUnit tests for TARGET_METHOD=paginate in system/ee/ExpressionEngine/Addons/structure/mod.structure.php (develop baseline) without production code changes. <!-- ralph:id=structure-mod-tests-019 -->
