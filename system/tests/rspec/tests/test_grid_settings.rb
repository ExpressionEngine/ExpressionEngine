...
#
#		click_link 'News'
#		click_link 'Create a New Channel Field'
#
#		fill_in 'field_label', :with => 'Test Grid'
#
#		FieldSettings::select_fieldtype('Grid')
#	end
#
...
#		find_field('field_name').value.should eq 'test_grid'
#		page.should have_text('Grid Field Options')
#	end
#
