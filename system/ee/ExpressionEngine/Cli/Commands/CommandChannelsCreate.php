 ...
 */
class CommandChannelsCreate extends Cli
{
    /**
     * name of command
     * @var string
     */
    public $name = 'Create Channel';

    /**
     * signature of command
     * @var string
     */
    public $signature = 'channels:create';

    /**
     * How to use command
     * @var string
     */
    public $usage = 'php eecli.php channels:create --name="Channel Name" --short_name="channel_short_name" [--site="Site Name or ID"] [--description="Channel Description"]';
