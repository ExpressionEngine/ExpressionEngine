...
<div class="upgrade-success-banner__wrapper" style="background-image: url('<?=URL_THEMES?>asset/img/ee-pro-promo-banner-bg@2x.png');">
  <a href="" class="upgrade-success-banner__title">&#127881; ExpressionEngine <strong>6.1.0</strong></a>
  <a href="" class="upgrade-success-banner__title-link"><i class="fas fa-clipboard"></i> Release Notes&hellip;</a>
  ...
  <div class="upgrade-success-banner__blurb-wrapper" style="grid-template-columns: repeat(3, 1fr);">
    <a href="" class="upgrade-success-banner__blurb">
