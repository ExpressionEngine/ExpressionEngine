    ...
    <div class="filter-search-bar">
        ...
        <div class="filter-search-bar__search-row">
            ...
            <div class="filter-search-bar__item ">
                ...
                <div class="dropdown">
                    <div class="dropdown__scroll">
                        <a class="dropdown__link" href="&viewtype=thumb&perpage=25&sort_col=title&sort_dir=asc">
                            <i class="fas fa-sort-amount-up"></i>
                            Title Asc
                        </a>
                        <a class="dropdown__link" href="&viewtype=thumb&perpage=25&sort_col=title&sort_dir=desc">
