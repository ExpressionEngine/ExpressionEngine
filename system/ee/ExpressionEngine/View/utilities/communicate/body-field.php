<textarea aria-label="email body field" class="has-format-options required" name="message" cols="" rows="10"><?=set_value('message', $message)?></textarea>
<?=form_error('message')?>
<div class="format-options">
	<label for="mailtype"><?=lang('send_as')?></label>
