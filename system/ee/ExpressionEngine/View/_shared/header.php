...
?>
	...
	<div class="ee-wrapper-overflow">
        ...
        <div class="ee-main-header <?php if (!empty($head['class']) ): echo $head['class']; endif ?>">
          ...
          <a href="" class="sidebar-toggle<?php if (isset($collapsed_nav) && $collapsed_nav == '1') : ?> sidebar-toggle__collapsed<?php endif; ?>" title="<?=lang('toggle_sidebar')?>"><i class="fas fa-angle-<?php if (isset($collapsed_nav) && $collapsed_nav == '1') : ?>right<?php else : ?>left<?php endif; ?>"></i></a>
