			...
			<div class="ee-sidebar <?php if (!isset($ee_cp_viewmode) || $ee_cp_viewmode != 'classic') : ?> hidden<?php endif; ?><?php if (isset($collapsed_nav) && $collapsed_nav == '1') : ?> ee-sidebar__collapsed<?php endif; ?>" role="navigation" aria-label="site sidebar">
