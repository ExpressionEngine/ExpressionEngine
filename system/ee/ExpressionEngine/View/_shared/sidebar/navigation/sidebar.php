        ...
        <!-- This is the hard coded NEW sidebar: -->
        <div class="ee-sidebar__items">
          <a href="admin.php?/cp/homepage" class="ee-sidebar__item" title="Overview">
            <i class="fas fa-home"></i>    <span class="ee-sidebar__collapsed-hidden">Overview</span>
          </a>

          <!-- Content Links -->
          <div class="ee-sidebar__items-section">
            <span class="ee-sidebar__section-label">Content</span>
            <a href="admin.php?/cp/publish/edit" data-dropdown-use-root="true" data-dropdown-pos="right-start" class="ee-sidebar__item js-dropdown-hover" title="Entries">
              <i class="fas fa-newspaper"></i>    <span class="ee-sidebar__collapsed-hidden">Entries</span>
            </a>
            <a href="admin.php?/cp/files" class="ee-sidebar__item " title="Files">
              <i class="fas fa-folder"></i>    <span class="ee-sidebar__collapsed-hidden">Files</span>
            </a>
            <a href="admin.php?/cp/categories" class="ee-sidebar__item " title="Categories">
              <i class="fas fa-tags"></i>    <span class="ee-sidebar__collapsed-hidden">Categories</span>
            </a>
          </div>

          <!-- Member Links -->
          <div class="ee-sidebar__items-section">
            <span class="ee-sidebar__section-label">Members</span>
            <a href="admin.php?/cp/members" class="ee-sidebar__item " title="Members">
              <i class="fas fa-users"></i>    <span class="ee-sidebar__collapsed-hidden">Members</span>
            </a>
            <a href="admin.php?/cp/members/roles" class="ee-sidebar__item " title="Member Roles">
              <i class="fas fa-user-tag"></i>    <span class="ee-sidebar__collapsed-hidden">Roles</span>
            </a>
          </div>

          <!-- Custom Links -->
          <div class="ee-sidebar__items-custom">
            <span class="ee-sidebar__section-label">Custom</span>
              <nav class="nav-custom">
                <a class="ee-sidebar__item" href="" title="Custom Link 1"><span class="ee-sidebar__item-custom-icon">C</span><span class="ee-sidebar__collapsed-hidden">Custom Link 1</span></a>
                <a class="ee-sidebar__item" href="" title="Custom Link 2"><span class="ee-sidebar__item-custom-icon">C</span><span class="ee-sidebar__collapsed-hidden">Custom Link 2</span></a>
              </nav>
          </div>

          <!-- Developer Links -->
          <div class="ee-sidebar__items-dev">
            <span class="ee-sidebar__section-label">Developer</span>
            <a href="admin.php?/cp/channels" data-dropdown-use-root="true" data-dropdown-pos="right-start" class="ee-sidebar__item js-dropdown-hover" title="Design">
              <i class="fas fa-drafting-compass"></i>    <span class="ee-sidebar__collapsed-hidden">Design</span>
            </a>
            <a href="admin.php?/cp/msm" data-dropdown-use-root="true" data-dropdown-pos="right-start" class="ee-sidebar__item js-dropdown-hover" title="Tools">
              <i class="fas fa-tools"></i>    <span class="ee-sidebar__collapsed-hidden">Tools</span>
            </a>
            <a href="admin.php?/cp/addons" class="ee-sidebar__item " title="Add-Ons">
              <i class="fas fa-puzzle-piece"></i>    <span class="ee-sidebar__collapsed-hidden">Add-Ons</span>
            </a>
            <a href="admin.php?/cp/settings" class="ee-sidebar__item " title="Settings">
              <i class="fas fa-cog"></i>    <span class="ee-sidebar__collapsed-hidden">Settings</span>
            </a>
          </div>
        ...
        <!-- This is the existing OLD sidebar: -->
        <div class="ee-sidebar__items" style="display: none;">
					<div>
						<?=$sidebar?>
					</div>
