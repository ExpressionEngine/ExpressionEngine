...
<div class="rule <?php if ($hiddenTemplate) :?>rule-blank-row hidden <?php endif; ?>" >
    ...
    <div class="condition-rule-operator-wrap" data-new-rule-row-id="<?=$ruleRowId?>">
        <?php if ($hiddenTemplate || empty($operatorFieldDefault)) : ?>
            <select name="" id="" class="empty-select" disabled="disabled" aria-label="conditional operator select"></select>
    ...
    <div class="condition-rule-value-wrap" data-new-rule-row-id="<?=$ruleRowId?>">
        <?php
            if ($hiddenTemplate || $error) :
                echo '<input type="text" disabled="disabled" aria-label="conditional rule value input">';
        ...
        ?>
            <input type="text" value="<?=$value?>" name="condition[<?=$setId?>][<?=$rowId?>][value]" aria-label="conditional rule value input">>
        <?php endif; ?>
    </div>
