...
$rule = [
    ...
    'field_name' => 'condition[new_set_0][new_0][condition_field_id]',
        ...
        <div class="field-conditionset">
            ...
            <div class="rules">
                ...
                <div class="rule">
                    ...
                    <div class="condition-rule-operator-wrap">
                        <select name="condition[new_set_0][new_0][evaluation_rule]" id="" class="empty-select"></select>
                    </div>
                    <div class="condition-rule-value-wrap">
                        <input type="text" name="condition[new_set_0][new_0][value]">
                    </div>
                </div>
            </div>
