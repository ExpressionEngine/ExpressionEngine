<button type="button" class="filter-bar__button has-sub js-dropdown-toggle button button--default button--small" data-filter-label="<?=strtolower((string) lang($label))?>">
	<?=lang($label)?>
	<?php if ($value): ?>
