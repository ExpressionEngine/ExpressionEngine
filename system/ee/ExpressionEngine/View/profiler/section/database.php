				...
				<ul class="query-list">
					<?php foreach ($dupe_queries as $dupe): ?>
						<li>
							...
							<div class="query-wrap"><pre><code><?=htmlspecialchars((string) $dupe['query'], ENT_QUOTES, 'UTF-8')?></code></pre></div>
			...
			<ul class="query-list">
				<?php foreach ($queries as $query): ?>
					...
					<li <?=$warn?>>
						...
						<div class="query-wrap"><pre><code class="sql"><?=htmlspecialchars((string) $query['query'], ENT_QUOTES, 'UTF-8')?></code></pre></div>
