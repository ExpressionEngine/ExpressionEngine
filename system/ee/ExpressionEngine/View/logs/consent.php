			...
			<div class="list-item">
				<div class="list-item__content">
					<div style="margin-bottom: 20px;">
						...
						<b><?=lang('username')?>:</b> <?php if (!empty($log->member_id)) : ?><a href="<?=ee('CP/URL')->make('members/profile', array('id' => $log->member_id))?>"><?=$log->Member->username?></a><?php else: echo lang('anonymous'); endif; ?><?php if ($log->ip_address) : ?>,
