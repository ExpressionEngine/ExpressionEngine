...
$method = new ReflectionMethod('File_ft', 'pre_loop');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft pre_loop doubles.
 *
 * @return FileFtFileFieldStub
 */
function file_ft_pre_loop_bootstrap()
{
    ee()->resetMocks();
...
/**
 * Build a File_ft instance for pre_loop() coverage runs.
 *
 * @return File_ft
 */
function file_ft_pre_loop_make_fieldtype()
{
    return new File_ft();
}
...
file_ft_pre_loop_bootstrap();
file_ft_pre_loop_make_fieldtype()->pre_loop([
    'file_id' => 14,
...
file_ft_pre_loop_bootstrap();
file_ft_pre_loop_make_fieldtype()->pre_loop(false);
...
$functionCoverage = $fileCoverage['functions']['File_ft->pre_loop'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
