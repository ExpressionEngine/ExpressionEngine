...
$method = new ReflectionMethod('File_ft', 'replace_raw_content');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_raw_content() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_raw_content_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_raw_content().
         *
         * @param string $type
         * @param mixed $value
         * @return object
...
/**
 * Build a File_ft instance for replace_raw_content() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_raw_content_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_raw_content_bootstrap('encoded::payload');
file_ft_replace_raw_content_make_fieldtype()->replace_raw_content([
...
file_ft_replace_raw_content_bootstrap(0);
file_ft_replace_raw_content_make_fieldtype()->replace_raw_content([
    'raw_output' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_raw_content'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
