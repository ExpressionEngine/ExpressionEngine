...
$method = new ReflectionMethod('File_ft', 'replace_url_encode');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_url_encode() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_url_encode_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Store the formatter result returned from urlEncode().
         *
         * @param mixed $returnValue
         * @return void
         */
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_url_encode().
         *
         * @param string $type
         * @param mixed $value
         * @return object
...
/**
 * Build a File_ft instance for replace_url_encode() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_url_encode_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_url_encode_bootstrap('encoded::payload');
file_ft_replace_url_encode_make_fieldtype()->replace_url_encode([
...
file_ft_replace_url_encode_bootstrap(0);
file_ft_replace_url_encode_make_fieldtype()->replace_url_encode([
    'url' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_url_encode'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
