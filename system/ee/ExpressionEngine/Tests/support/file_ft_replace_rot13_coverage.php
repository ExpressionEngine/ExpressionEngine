...
$method = new ReflectionMethod('File_ft', 'replace_rot13');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_rot13() doubles.
 *
 * @return void
 */
function file_ft_replace_rot13_bootstrap(): void
{
    ee()->resetMocks();
...
/**
 * Build a File_ft instance for replace_rot13() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_rot13_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_rot13_bootstrap();
file_ft_replace_rot13_make_fieldtype()->replace_rot13([
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_rot13'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
