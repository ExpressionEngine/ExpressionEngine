...
$method = new ReflectionMethod('Sql_structure', 'create_full_uri');
...
$happyResult = $sql->create_full_uri('/parent', 'child');
$preservedParentResult = $sql->create_full_uri('/parent section/', 'child?x=1#frag');
$zeroResult = $sql->create_full_uri('/parent', '0');
$rootParentResult = $sql->create_full_uri('/', 'child');
$rootResult = $sql->create_full_uri('', '@#$%^&*()');
...
$functionCoverage = $fileCoverage['functions']['Sql_structure->create_full_uri'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
...
file_put_contents($outputFile, json_encode([
    ...
    'preserved_parent_result' => $preservedParentResult,
    'zero_result' => $zeroResult,
    'root_parent_result' => $rootParentResult,
