...
require_once __DIR__ . '/../ExpressionEngine/Addons/file/FT/FileFtReplaceResizeTest.php';
...
$method = new ReflectionMethod('File_ft', 'replace_resize');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Build a coverage spy for replace_resize().
 *
 * @return FileFtReplaceResizeSpy
 */
function file_ft_replace_resize_make_fieldtype()
{
    return new FileFtReplaceResizeSpy();
}
...
file_ft_replace_resize_make_fieldtype()->replace_resize(['file_id' => 4], [], '{file:url}');
file_ft_replace_resize_make_fieldtype()->replace_resize(['file_id' => 7], ['wrap' => 'plain'], false);
file_ft_replace_resize_make_fieldtype()->replace_resize([], ['width' => '1200'], '{file:url}');
file_ft_replace_resize_make_fieldtype()->replace_resize(
    ['file_id' => 11, 'url' => '{filedir_3}manual.pdf'],
    ['height' => '600'],
    false
);

$defaultedModelObject = new FileFtReplaceResizeModelObjectStub(
    'hero.jpg',
    's3-assets',
    '/srv/uploads/hero.jpg'
);
file_ft_replace_resize_make_fieldtype()->replace_resize(
    ['model_object' => new FileFtReplaceResizeModelObjectStub(
        'hero.jpg',
        's3-assets',
        '/srv/uploads/hero.jpg',
        false,
...
$preseededModelObject = new FileFtReplaceResizeModelObjectStub(
    'hero.jpg',
    's3-assets',
    '/srv/uploads/hero.jpg',
    true,
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_resize'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
