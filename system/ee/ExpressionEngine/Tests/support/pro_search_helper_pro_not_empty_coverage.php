...
$function = new ReflectionFunction('pro_not_empty');
...
$results = [
    'null' => pro_not_empty(null),
    'false' => pro_not_empty(false),
    'empty_string' => pro_not_empty(''),
    'zero_string' => pro_not_empty('0'),
    'zero_integer' => pro_not_empty(0),
    'zero_float' => pro_not_empty(0.0),
    'empty_array' => pro_not_empty([]),
    'non_empty_array' => pro_not_empty(['alpha']),
    'true' => pro_not_empty(true),
    'blank_string' => pro_not_empty(' '),
    'object' => pro_not_empty(new stdClass()),
];
...
$functionCoverage = $fileCoverage['functions']['pro_not_empty'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
