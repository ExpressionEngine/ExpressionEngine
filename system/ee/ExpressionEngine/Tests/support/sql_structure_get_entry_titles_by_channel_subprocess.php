...
$invalidResult = $sql->get_entry_titles_by_channel('bad-channel');
$numericStringResult = $sql->get_entry_titles_by_channel('4');
$emptyResult = $sql->get_entry_titles_by_channel(0);
