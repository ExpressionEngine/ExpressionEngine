...
$function = new ReflectionFunction('pro_by_keywords');
...
$comparisons = [
    'sorts_before' => pro_by_keywords(['keywords_clean' => 'Alpha'], ['keywords_clean' => 'bravo']),
    'sorts_after' => pro_by_keywords(['keywords_clean' => 'zulu'], ['keywords_clean' => 'Bravo']),
    'case_insensitive_equal' => pro_by_keywords(['keywords_clean' => 'MiXeD'], ['keywords_clean' => 'mixed']),
];
$rows = [
...
$functionCoverage = $fileCoverage['functions']['pro_by_keywords'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
...
file_put_contents($outputFile, json_encode([
    ...
    'sorted_entry_ids' => array_column($rows, 'entry_id'),
], JSON_PRETTY_PRINT));
