...
$function = new ReflectionFunction('is_ajax');
...
$originalHeaderWasSet = array_key_exists('HTTP_X_REQUESTED_WITH', $_SERVER);
$originalHeaderValue = $originalHeaderWasSet ? $_SERVER['HTTP_X_REQUESTED_WITH'] : null;
...
$missingHeaderResult = is_ajax();

$_SERVER['HTTP_X_REQUESTED_WITH'] = 'XMLHttpRequest';
$exactHeaderResult = is_ajax();

$_SERVER['HTTP_X_REQUESTED_WITH'] = 'xmlhttprequest';
$lowercaseHeaderResult = is_ajax();

$_SERVER['HTTP_X_REQUESTED_WITH'] = '';
$emptyHeaderResult = is_ajax();

$_SERVER['HTTP_X_REQUESTED_WITH'] = '0';
$zeroStringHeaderResult = is_ajax();

$_SERVER['HTTP_X_REQUESTED_WITH'] = null;
$nullHeaderResult = is_ajax();

if ($originalHeaderWasSet) {
    $_SERVER['HTTP_X_REQUESTED_WITH'] = $originalHeaderValue;
}
...
$functionCoverage = $fileCoverage['functions']['is_ajax'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
...
file_put_contents($outputFile, json_encode([
    ...
    'missing_header_result' => $missingHeaderResult,
    'exact_header_result' => $exactHeaderResult,
    'lowercase_header_result' => $lowercaseHeaderResult,
    'empty_header_result' => $emptyHeaderResult,
    'zero_string_header_result' => $zeroStringHeaderResult,
    'null_header_result' => $nullHeaderResult,
], JSON_PRETTY_PRINT));
