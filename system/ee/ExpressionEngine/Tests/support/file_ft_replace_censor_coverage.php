...
$method = new ReflectionMethod('File_ft', 'replace_censor');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_censor() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_censor_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Store the formatter result returned from censor().
         *
         * @param mixed $returnValue
         * @return void
         */
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_censor().
         *
         * @param string $type
         * @param mixed $value
         * @return object
...
/**
 * Build a File_ft instance for replace_censor() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_censor_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_censor_bootstrap('censored::payload');
file_ft_replace_censor_make_fieldtype()->replace_censor([
...
file_ft_replace_censor_bootstrap(0);
file_ft_replace_censor_make_fieldtype()->replace_censor([
    'title' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_censor'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
