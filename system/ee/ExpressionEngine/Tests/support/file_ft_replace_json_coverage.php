...
$method = new ReflectionMethod('File_ft', 'replace_json');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_json() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_json_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Store the formatter result returned from json().
         *
         * @param mixed $returnValue
         * @return void
         */
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_json().
         *
         * @param string $type
         * @param mixed $value
         * @return object
...
/**
 * Build a File_ft instance for replace_json() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_json_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_json_bootstrap('json::payload');
file_ft_replace_json_make_fieldtype()->replace_json([
...
file_ft_replace_json_bootstrap(0);
file_ft_replace_json_make_fieldtype()->replace_json([
    'url' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_json'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
