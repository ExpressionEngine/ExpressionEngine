...
require_once __DIR__ . '/../ExpressionEngine/Addons/file/FT/FileFtReplaceAvifTest.php';
...
$method = new ReflectionMethod('File_ft', 'replace_avif');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Build a coverage spy for replace_avif().
 *
 * @return FileFtReplaceAvifSpy
 */
function file_ft_replace_avif_make_fieldtype()
{
    return new FileFtReplaceAvifSpy();
}
...
file_ft_replace_avif_make_fieldtype()->replace_avif([], ['quality' => '80'], '{file:url}');
file_ft_replace_avif_make_fieldtype()->replace_avif(
...
file_ft_replace_avif_make_fieldtype()->replace_avif(
    [
        'model_object' => new FileFtReplaceAvifModelObjectStub(
            'hero.jpg',
            's3-assets',
...
$defaultedModelObject = new FileFtReplaceAvifModelObjectStub(
    'hero.jpg',
    's3-assets',
    '/srv/uploads/hero.jpg'
);
...
$preseededModelObject = new FileFtReplaceAvifModelObjectStub(
    'hero.jpg',
    's3-assets',
    '/srv/uploads/hero.jpg',
    true,
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_avif'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
