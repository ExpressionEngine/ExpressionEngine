...
require_once __DIR__ . '/../ExpressionEngine/Addons/file/FT/FileFtReplaceWebpTest.php';
...
$method = new ReflectionMethod('File_ft', 'replace_webp');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Build a coverage spy for replace_webp().
 *
 * @return FileFtReplaceWebpSpy
 */
function file_ft_replace_webp_make_fieldtype()
{
    return new FileFtReplaceWebpSpy();
}
...
file_ft_replace_webp_make_fieldtype()->replace_webp([], ['quality' => '80'], '{file:url}');
file_ft_replace_webp_make_fieldtype()->replace_webp(
...
file_ft_replace_webp_make_fieldtype()->replace_webp(
    [
        'model_object' => new FileFtReplaceWebpModelObjectStub(
            'hero.jpg',
            's3-assets',
...
$defaultedModelObject = new FileFtReplaceWebpModelObjectStub(
    'hero.jpg',
    's3-assets',
    '/srv/uploads/hero.jpg'
);
...
$preseededModelObject = new FileFtReplaceWebpModelObjectStub(
    'hero.jpg',
    's3-assets',
    '/srv/uploads/hero.jpg',
    true,
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_webp'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
