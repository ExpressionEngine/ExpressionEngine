...
$function = new ReflectionFunction('pro_strpos_all');
...
pro_strpos_all('alpha beta alpha', 'alpha');
pro_strpos_all('a.b.a.b', '.');
pro_strpos_all('abc', 'z');
pro_strpos_all(null, 'a');
...
$functionCoverage = $fileCoverage['functions']['pro_strpos_all'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
