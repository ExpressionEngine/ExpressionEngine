...
$method = new ReflectionMethod('File_ft', 'replace_limit');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_limit() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_limit_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Store the formatter result returned from limitChars().
         *
         * @param mixed $returnValue
         * @return void
         */
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_limit().
         *
         * @param string $type
         * @param mixed $value
         * @return object
...
/**
 * Build a File_ft instance for replace_limit() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_limit_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_limit_bootstrap('limited::payload');
file_ft_replace_limit_make_fieldtype()->replace_limit([
...
file_ft_replace_limit_bootstrap('trimmed::payload');
file_ft_replace_limit_make_fieldtype()->replace_limit([
...
file_ft_replace_limit_bootstrap(0);
file_ft_replace_limit_make_fieldtype()->replace_limit([
    'url' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_limit'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
