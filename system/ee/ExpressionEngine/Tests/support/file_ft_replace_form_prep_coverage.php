...
$method = new ReflectionMethod('File_ft', 'replace_form_prep');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_form_prep() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_form_prep_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Store the formatter result returned from encodeEETags().
         *
         * @param mixed $returnValue
         * @return void
         */
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_form_prep().
         *
         * @param string $type
         * @param mixed $value
         * @return object
        ...
        public function make($type, $value)
        {
            return new class($this->returnValue) {
                ...
                /**
                 * Mirror the fluent formatter step used before encoding EE tags.
                 *
                 * @return self
                 */
...
/**
 * Build a File_ft instance for replace_form_prep() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_form_prep_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_form_prep_bootstrap('prepared::payload');
file_ft_replace_form_prep_make_fieldtype()->replace_form_prep([
...
file_ft_replace_form_prep_bootstrap(0);
file_ft_replace_form_prep_make_fieldtype()->replace_form_prep([
    'url' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_form_prep'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
