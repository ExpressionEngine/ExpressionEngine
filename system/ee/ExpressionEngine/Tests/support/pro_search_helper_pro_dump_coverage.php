...
$function = new ReflectionFunction('pro_dump');
...
register_shutdown_function(function () use ($outputFile, $target, $function, $xdebugAvailable) {
    ...
    $functionCoverage = $fileCoverage['functions']['pro_dump'] ?? ['branches' => [], 'paths' => []];
    $coveredLines = [];
