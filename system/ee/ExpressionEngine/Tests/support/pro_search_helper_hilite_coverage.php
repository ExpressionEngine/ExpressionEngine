...
$function = new ReflectionFunction('pro_hilite');
...
pro_hilite('alpha beta alpha', 'alpha');
pro_hilite('Find a+b? before a+b?.', 'a+b?');
pro_hilite('a#b#a#b', '#');
pro_hilite('Alpha alpha', 'alpha');
pro_hilite('<p>alpha & beta</p>', 'alpha & beta');
pro_hilite('alpha beta', 'gamma');
pro_hilite('abc', '');
...
$functionCoverage = $fileCoverage['functions']['pro_hilite'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
