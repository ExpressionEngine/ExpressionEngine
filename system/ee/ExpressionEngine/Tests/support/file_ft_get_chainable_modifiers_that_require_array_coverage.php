...
$method = new ReflectionMethod('File_ft', 'getChainableModifiersThatRequireArray');
...
$fieldtype->getChainableModifiersThatRequireArray();
$fieldtype->getChainableModifiersThatRequireArray([
    'file_id' => 18,
    'title' => 'Manual PDF',
]);
$fieldtype->getChainableModifiersThatRequireArray('manual pdf');
$fieldtype->getChainableModifiersThatRequireArray(null);
...
$functionCoverage = $fileCoverage['functions']['File_ft->getChainableModifiersThatRequireArray'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
