...
$method = new ReflectionMethod('File_ft', 'replace_encrypt');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_encrypt() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_encrypt_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Store the formatter result returned from encrypt().
         *
         * @param mixed $returnValue
         * @return void
         */
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_encrypt().
         *
         * @param string $type
         * @param mixed $value
         * @return object
...
/**
 * Build a File_ft instance for replace_encrypt() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_encrypt_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_encrypt_bootstrap('encrypted::payload');
file_ft_replace_encrypt_make_fieldtype()->replace_encrypt([
...
file_ft_replace_encrypt_bootstrap(0);
file_ft_replace_encrypt_make_fieldtype()->replace_encrypt([
    'url' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_encrypt'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
