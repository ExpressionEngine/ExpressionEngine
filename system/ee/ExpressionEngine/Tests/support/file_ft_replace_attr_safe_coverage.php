...
$method = new ReflectionMethod('File_ft', 'replace_attr_safe');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_attr_safe() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_attr_safe_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Store the formatter result returned from attributeSafe().
         *
         * @param mixed $returnValue
         * @return void
         */
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_attr_safe().
         *
         * @param string $type
         * @param mixed $value
         * @return object
...
/**
 * Build a File_ft instance for replace_attr_safe() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_attr_safe_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_attr_safe_bootstrap('escaped::payload');
file_ft_replace_attr_safe_make_fieldtype()->replace_attr_safe([
...
file_ft_replace_attr_safe_bootstrap(0);
file_ft_replace_attr_safe_make_fieldtype()->replace_attr_safe([
    'url' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_attr_safe'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
