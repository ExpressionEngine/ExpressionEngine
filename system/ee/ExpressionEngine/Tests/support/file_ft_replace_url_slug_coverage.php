...
$method = new ReflectionMethod('File_ft', 'replace_url_slug');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_url_slug() doubles.
 *
 * @param mixed $returnValue
 * @return void
 */
function file_ft_replace_url_slug_bootstrap($returnValue): void
{
    ee()->resetMocks();
    ...
    ee()->setMock('Format', new class($returnValue) {
        ...
        /**
         * Store the formatter result returned from urlSlug().
         *
         * @param mixed $returnValue
         * @return void
         */
        ...
        /**
         * Return the text formatter used by ModifiableTrait::replace_url_slug().
         *
         * @param string $type
         * @param mixed $value
         * @return object
...
/**
 * Build a File_ft instance for replace_url_slug() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_url_slug_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_url_slug_bootstrap('slugged::payload');
file_ft_replace_url_slug_make_fieldtype()->replace_url_slug([
...
file_ft_replace_url_slug_bootstrap(0);
file_ft_replace_url_slug_make_fieldtype()->replace_url_slug([
    'filename' => '',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_url_slug'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
