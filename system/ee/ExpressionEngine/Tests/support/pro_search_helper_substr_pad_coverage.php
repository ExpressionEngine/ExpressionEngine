...
$function = new ReflectionFunction('pro_substr_pad');
...
pro_substr_pad('alpha beta gamma', [6], 4, 0);
pro_substr_pad('alpha beta gamma', [6], 4, 2);
pro_substr_pad('alpha beta gamma', [1], 3, 5);
pro_substr_pad('alpha beta gamma', [12], 5, 3);
pro_substr_pad('alpha beta gamma', [6], 0, 2);
pro_substr_pad('alpha beta gamma beta', [6, 0], 5, 0);
pro_substr_pad('alpha beta gamma', [], 4, 2);
@pro_substr_pad('alpha beta gamma', null, 4, 2);
...
$functionCoverage = $fileCoverage['functions']['pro_substr_pad'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
