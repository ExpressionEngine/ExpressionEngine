...
$method = new ReflectionMethod('File_ft', 'replace_length');
$xdebugAvailable = function_exists('xdebug_start_code_coverage') && function_exists('xdebug_get_code_coverage');

/**
 * Reset EE mocks and seed the shared File_ft replace_length doubles.
 *
 * @return void
 */
function file_ft_replace_length_bootstrap(): void
{
    ee()->resetMocks();
...
/**
 * Build a File_ft instance for replace_length() coverage runs.
 *
 * @return File_ft
 */
function file_ft_replace_length_make_fieldtype(): File_ft
{
    return new File_ft();
}
...
file_ft_replace_length_bootstrap();
file_ft_replace_length_make_fieldtype()->replace_length([
    'file_size' => '001024',
...
$functionCoverage = $fileCoverage['functions']['File_ft->replace_length'] ?? ['branches' => [], 'paths' => []];
$coveredLines = [];
