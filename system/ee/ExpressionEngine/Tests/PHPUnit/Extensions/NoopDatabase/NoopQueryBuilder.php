...
namespace ExpressionEngine\Tests\PHPUnit\Extensions\NoopDatabase;
...
class NoopActiveRecord
{
    ...
    /** Untouched Functions **/
    protected function set_insert_batch($key, $value = '', $escape = true)
    {
        return $this;
    }
    protected function set_update_batch($key, $index = '', $escape = true)
    {
        return $this;
    }

    protected function set($key, $value = '', $escape = true)
    {
        return $this;
    }
    ...
    protected function select_max($select = '', $alias = '')
    {
        return $this;
    }
    protected function select_min($select = '', $alias = '')
    {
        return $this;
    }
    protected function select_avg($select = '', $alias = '')
    {
        return $this;
    }
    protected function select_sum($select = '', $alias = '')
    {
        return $this;
    }
    protected function join($table, $cond, $type = '')
    {
        return $this;
    }
    protected function where($key, $value = null, $escape = true)
    {
        return $this->_where($key, $value, 'AND ', $escape);
    }
    protected function or_where($key, $value = null, $escape = true)
    {
        return $this;
    }
    protected function where_in($key = null, $values = null)
    {
        return $this;
    }
    protected function or_where_in($key = null, $values = null)
    {
        return $this;
    }
    protected function where_not_in($key = null, $values = null)
    {
        return $this;
    }
    protected function or_where_not_in($key = null, $values = null)
    {
        return $this;
    }
    ...
    protected function like($field, $match = '', $side = 'both')
    {
        return $this;
    }
    protected function not_like($field, $match = '', $side = 'both')
    {
        return $this;
    }
    protected function or_like($field, $match = '', $side = 'both')
    {
        return $this;
    }
    protected function or_not_like($field, $match = '', $side = 'both')
    {
        return $this;
    }
    ...
    protected function group_by($by)
    {
        return $this;
    }
    protected function distinct($val = true)
    {
        return $this;
    }
