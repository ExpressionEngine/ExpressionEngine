...
/**
 * Test Select fieldtype update method
 */
class SelectUpdateTest extends SelectTestBase
{
    /**
    ...
    /**
     * Test update method with version containing numbers only
     */
    public function testUpdateMethodWithNumericOnlyVersion()
    {
        $version = '12345';
    ...
    /**
     * Test update method with version containing letters only
     */
    public function testUpdateMethodWithLettersOnlyVersion()
    {
        $version = 'abc';
