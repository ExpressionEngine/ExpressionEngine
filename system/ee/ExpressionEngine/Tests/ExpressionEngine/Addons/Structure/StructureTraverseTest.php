...
class StructureTraverseTest extends StructureTestBase
{
    ...
    protected function setSqlStubWithTraverse($sitePages, string $uri, array $selectiveData): void
    {
        $sql = new class($sitePages, $uri, $selectiveData) {
            private $sitePages;
            private $uri;
            private $selectiveData;

            public function __construct($sitePages, $uri, $selectiveData)
            {
