...
class FrontEdit
{
    ...
    public function loadFrontEditAssets($output)
    {
        ...
        $element = '<span class="eeFrontEdit MARKER_CLASS" data-ee-editable data-editableid="'
                    ...
                    . '<img src="' . $pencilUrl . '" width="24px" height="24px" alt="pencil icon" style="cursor:pointer !important; filter: drop-shadow(0 1px 3px rgba(0,0,0,.20)) !important; vertical-align: bottom !important; border-radius: 0 !important; width: unset !important;" />'
                    . '</span>';
        $frontEditPermission = [];
        $entry_data = [];
