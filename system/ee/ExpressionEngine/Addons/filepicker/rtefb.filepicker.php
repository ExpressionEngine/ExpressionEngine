...
class Filepicker_rtefb extends AbstractRteFilebrowser
{
    ...
    public function addJs($uploadDir)
    {
		...
		ee()->javascript->set_global([
			'Teepee.fpUrl' => ee('CP/FilePicker')->make($uploadDir)->getUrl()->compile(),
		]);
		ee()->javascript->output("window.Teepee_browseImages = function(sourceElement, params) {
			Teepee.loadEEFileBrowser(sourceElement, params, '".$uploadDir."', 'image');
		}");
    }
