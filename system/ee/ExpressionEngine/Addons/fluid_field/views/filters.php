<?php if (count($filters) < 20) : ?>
    <?php foreach ($filters as $filter) : ?>
        <a href="#" class="button button--auto button--default button--small" data-field-name="<?=$filter->name?>" data-field-type="<?=$filter->type?>">
...
<?php else : ?>
    ...
    <div class="dropdown">
        <?php foreach ($filters as $filter) : ?>
            <a href="#" class="dropdown__link" data-field-name="<?=$filter->name?>" data-field-type="<?=$filter->type?>"><img src="<?=$filter->icon?>" width="12" height="12" /> <?=$filter->label?></a>
        <?php endforeach; ?>
    </div>
<?php endif; ?>