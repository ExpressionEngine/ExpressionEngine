<div class="fluid__item <?php if ($reorderable): ?>fluid__item--reorderable<?php endif ?><?=(isset($collapse_rows) && $collapse_rows ? ' fluid__item--collapsed' : '')?>" data-field-name="<?=$field_name?>" data-field-type="<?=$field->getType()?>">
