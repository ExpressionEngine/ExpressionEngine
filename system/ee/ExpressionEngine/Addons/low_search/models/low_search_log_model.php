...
class Low_search_log_model extends Low_search_model
{
    ...
    public function get_member_ids()
    {
        ...
        return low_flatten_results($query->result_array(), 'member_id');
    }
    ...
    public function get_dates()
    {
        ...
        return low_flatten_results($query->result_array(), 'search_date');
    }
    ...
    public function add_num_results($num, $log_id = false)
    {
        ...
        if (! $log_id) {
            $log_id = low_get_cache('low_search', $this->key);
        }
