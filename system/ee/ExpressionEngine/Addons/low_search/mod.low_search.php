...
if (! class_exists('Low_search_base')) {
    require_once(PATH_ADDONS . 'low_search/base.low_search.php');
}
...
class Low_search
{
    ...
    public function results()
    {
        ...
        if (
            ...
            // Also set cache
            low_set_cache($this->package, ee()->low_search_log_model->key, $this->log_id);
        }
        ...
        } elseif ($entry_ids = ee()->low_search_filters->exclude()) {
        ...
        low_set_cache($this->package, 'shortcut', $this->shortcut);
