...
class RedactorYService extends RedactorService implements RteService {

    protected static $type = 'redactorY';
    ...
    protected function insertConfigJsById()
    {
        ...
        if (!empty($this->toolset)) {
            ...
            $config = $baseConfig;
            $configHandle = 'redactorydefault0';
        }
    ...
    public static function defaultConfigSettings()
    {
        ...
        return array(
            'type' => static::$type,
            'toolbar' => static::defaultToolbars()['RedactorY Basic'],
            'height' => '200',
            'upload_dir' => 'all'
        );
    }
