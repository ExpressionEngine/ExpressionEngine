...
class Low_variables_pro extends AbstractProlet implements InitializableProletInterface
{
    protected $name = 'Low Variables';
    ...
    public function index()
    {
        ...
        foreach ($local as $var) {
            ...
            $rest = 'admin.php?/cp/addons/settings/low_variables/edit_var/' . $id;
            $base = $base . $rest;
