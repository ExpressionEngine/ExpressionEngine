...
$table->setNoResultsText('teepee_no_configs');
...
foreach ($configs as $config) {
    ...
    ee('CP/Modal')->addModal(
        ...
        $this->make('ee:_shared/modal_confirm_remove')->render(array(
            ...
            'checklist' => array(array('desc' => $config['name'], 'kind' => lang('teepee_config')))
        ))
    );
}
...
<div class="box">
    <div class="tbl-ctrls">
        <fieldset class="tbl-search right">
            <a class="btn tn action" href="<?= $newConfig ?>"><?=lang('teepee_create_config')?></a>
        </fieldset>
        <h1><?= $pageTitle ?></h1>
