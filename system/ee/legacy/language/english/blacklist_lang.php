...
'whitelist_desc' =>
'Whitelists <b>allow</b> access to your website via specific <abbr title="Internet Protocol">IP</abbr> address, user agents and <abbr title="Unified Resource Locator">URL</abbr>s.',

'blacklist' =>
'Blacklist',

'blacklist_desc' =>
'Blacklists <b>disallow</b> access to your website via specific <abbr title="Internet Protocol">IP</abbr> address, user agents and <abbr title="Unified Resource Locator">URL</abbr>s.',

'ip_address' =>
'<abbr title="Internet Protocol">IP</abbr> address',

'ip_address_desc' =>
'<b>Place each <abbr title="Internet Protocol">IP</abbr> address on a separate line.</b><br>You may use <mark>*</mark> as a wild-card e.g. 123.456.<mark>*</mark>',
...
'url_desc' =>
'<b>Place each <abbr title="Unified Resource Locator">URL</abbr> on a separate line.</b>',
