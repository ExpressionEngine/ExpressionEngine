...
$lang = array(
	...
	"can_admin_design" => "Template & Design settings",
	"can_admin_design_desc" => "When set to <b>yes</b>, users assigned to this group may access the template and content settings.",
