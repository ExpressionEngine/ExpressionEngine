...
$lang = array(
    ...
    "index_status_empty" =>
    "You can now start building the index.",

    "index_out_of_date" =>
    "Index out of date",

    "index_status_old_one" =>
    "The search index of the following collection needs rebuilding:",

    "index_status_old_many" =>
    "The search index of these collections need rebuilding:",

    "alt_click" =>
    "<em>If this message persists, try alt-clicking the collection’s build index icon.</em>",
