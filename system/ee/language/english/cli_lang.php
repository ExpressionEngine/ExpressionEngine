...
$lang = array(
    ...
    // sites
    'command_sites_list_description' => 'Lists all MSM sites in the system',
    'command_sites_list_summary' => 'Displays all sites with their details in various formats',
    'command_sites_list_header' => 'Sites:',
    'command_sites_list_no_sites_found' => 'No sites found.',
    'command_sites_list_total' => 'Total sites: %d',
    'command_sites_id' => 'ID',
    'command_sites_name' => 'Short Name',
    'command_sites_label' => 'Name',
    'command_sites_desc' => 'Description',
    'command_sites_status' => 'Status',
    'command_sites_color' => 'Color Label',
    'command_sites_list_ask_format' => 'Output format (table, json, csv)?',
    'command_sites_list_option_format' => 'Output format: table, json, or csv',
    'command_sites_list_multiple_sites_disabled' => 'Multiple Sites Manager (MSM) is disabled.',
    'command_sites_ask_name' => 'Site short name (no spaces)?',
    'command_sites_ask_label' => 'Site name (human readable)?',
    'command_sites_ask_description' => 'Site description?',
    'command_sites_ask_color' => 'Site color label (hex code, e.g., #FF6600)?',
    'command_sites_adding_site' => 'Creating new MSM site...',
    'command_sites_site_added' => 'MSM site created successfully!',
    'command_sites_site_not_added' => 'MSM site could not be created.',

    'command_sites_delete_description' => 'Deletes an existing MSM site',
    'command_sites_delete_summary' => 'Deletes an existing MSM site and all its associated data',
    'command_sites_no_sites' => 'There are no sites that can be deleted.',
    'command_sites_delete_ask' => 'Which site do you want to delete?',
    'command_sites_delete_confirm' => 'Are you sure you want to delete this site %s and all its associated data? This action cannot be undone.',
    'command_sites_deleting_site' => 'Deleting MSM site...',
    'command_sites_site_deleted' => 'MSM site deleted successfully!',
    'command_sites_site_not_deleted' => 'MSM site could not be deleted.',
    'command_sites_force_delete' => 'Force delete without confirmation',
    'command_sites_site_not_found' => 'Site not found.',

    'command_sites_edit_description' => 'Edits an existing MSM site',
    'command_sites_edit_summary' => 'Edits an existing MSM site',
    'command_sites_edit_ask' => 'Which site do you want to edit?',
    'command_sites_fields' => 'Fields to edit (comma-separated): name, label, description, color, status',
    'command_sites_edit_which_fields' => 'Which fields do you want to edit? (comma-separated):',
    'command_sites_saving_site' => 'Saving MSM site...',
    'command_sites_site_saved' => 'MSM site saved successfully!',
    'command_sites_site_not_saved' => 'MSM site could not be saved.',
