...
$lang = array(
    ...
    'command_sites_add_description' => 'Adds a new MSM site',
    'command_sites_add_summary' => 'Adds a new MSM site to the system',
    ...
    'command_sites_fields' => 'Fields to edit (comma-separated):',
    ...
    'command_cgroups_add_description' => 'Adds a new category group',
    'command_cgroups_add_summary' => 'Adds a new category group to the system',
    ...
    'command_cgroups_delete_summary' => 'Deletes an existing category group and all its associated data',
    'command_cgroups_delete_description' => 'Deletes an existing category group',
    ...
    'command_categories_add_description' => 'Adds a new category',
    'command_categories_add_summary' => 'Adds a new category to the system',
    ...
    'command_categories_delete_description' => 'Deletes an existing category',
    'command_categories_delete_summary' => 'Deletes an existing category',
    ...
    'command_categories_edit_description' => 'Edits an existing category',
    'command_categories_edit_summary' => 'Edits an existing category',
    ...
    'command_entries_delete_description' => 'Deletes an existing channel entry',
    'command_entries_delete_summary' => 'Deletes an existing channel entry',
    ...
    'command_entries_add_description' => 'Adds a new channel entry',
    'command_entries_add_summary' => 'Adds a new channel entry to the system',
    ...
    'command_entries_edit_description' => 'Edits an existing channel entry',
    'command_entries_edit_summary' => 'Edits an existing channel entry',
    ...
    // members:list
    'command_members_list_description' => 'Lists all members in the system',
    'command_members_list_summary' => 'Displays all members with their details in various formats',
    'command_members_list_header' => 'Members:',
    'command_members_list_no_members_found' => 'No members found.',
    'command_members_list_total' => 'Total members: %d',


    // members:delete
    'command_members_delete_description' => 'Deletes an existing member',
    'command_members_delete_summary' => 'Deletes an existing member',
    'command_members_delete_ask' => 'Which member do you want to delete?',
    'command_members_delete_confirm' => 'Are you sure you want to delete this member %s? This action cannot be undone.',
    'command_members_deleting_member' => 'Deleting member...',
    'command_members_deleted' => 'Member deleted successfully!',
    'command_members_not_deleted' => 'Member could not be deleted.',
    'command_members_not_found' => 'Member not found.',
    'command_members_member_id' => 'Member ID',

    // Lang entries for command members:add
    'command_members_add_description'              => 'Creates a new member',
    'command_members_add_summary'                  => '',
    'command_members_add_begin'                    => 'Member creation is about to begin',
    'command_members_add_in_progress'              => 'Creating member: %s',
    'command_members_add_complete'                 => 'Member %s created successfully',
    'command_members_username'                     => 'Username',
    'command_members_email'                        => 'Email',
    'command_members_password'                     => 'Password',
    'command_members_password_confirm'             => 'Confirm Password',
    'command_members_screen_name'                  => 'Screen name',
    'command_members_role'                         => 'Role',
    'command_members_edit_which_fields'            => 'Which fields would you like to set?',
    'command_members_invalid_role'                 => 'Invalid role: %s',
    'command_members_added'                        => 'Member added successfully!',
    'command_members_not_added'                    => 'Member could not be added.',

    'command_members_edit_description'             => 'Edits an existing member',
    'command_members_edit_summary'                 => '',
    'command_members_edit_ask'                     => 'Which member do you want to edit?',
    'command_members_editing'                      => 'Editing member: %s',
    'command_members_not_found'                    => 'Member not found',
    'command_members_not_saved'                    => 'Member could not be saved',
