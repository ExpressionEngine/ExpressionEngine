...
class Member {
	...
	function custom_profile_data()
	{
		...
		foreach (array($results) as $row)
		{
			...
			$dates = array(
				'last_visit' => $default_fields['last_visit'],
				'last_activity' => $default_fields['last_activity'],
				'join_date' => $default_fields['join_date'],
				'last_entry_date' => $default_fields['last_entry_date'],
				'last_forum_post_date' => $default_fields['last_forum_post_date'],
				'last_comment_date' => $default_fields['last_comment_date']
			);
