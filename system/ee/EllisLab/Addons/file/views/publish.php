...
<p class="solo-btn<?php if ($file) echo " hidden";?>"><a class="btn action m-link file-field-filepicker" href="<?=$fp_url?>" rel="modal-file" data-input-image="<?=$field_name?>" data-input-value="<?=$field_name?>"><?=lang('choose_file')?></a></p>
