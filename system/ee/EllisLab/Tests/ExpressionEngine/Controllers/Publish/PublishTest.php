...
class PublishTest extends \PHPUnit_Framework_TestCase {
	...
	public function testRoutableMethods()
	{
		...
		foreach (get_class_methods('EllisLab\ExpressionEngine\Controller\Publish\Publish') as $method)
		{
		...
		$this->assertEquals(array('autosave', 'create', 'field'), $controller_methods);
	}
