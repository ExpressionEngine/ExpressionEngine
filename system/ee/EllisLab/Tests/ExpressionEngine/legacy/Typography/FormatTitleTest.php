...
class FormatTitleTest extends \PHPUnit_Framework_TestCase {
	...
	protected function markdownData()
	{
		return array(
			...
			// Links
			array('Link with title attribute', 'This is [an example](http://example.com/ "Title") inline link.', 'This is [an example](http://example.com/ &#8220;Title&#8221;) inline link.'),
			...
			array('Image tag with title', '![Alt text](/path/to/img.jpg "Optional title")', '![Alt text](/path/to/img.jpg &#8220;Optional title&#8221;)'),
