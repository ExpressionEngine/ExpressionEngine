...
$lang['locate_license_number'] = 'Available in the <a href="https://secure.expressionengine.com/download.php">download area</a> of the ExpressionEngine.com site.  30 Day Trial installations may leave this field empty.';
...
$lang['unreadable_database'] = 'Your database.php file is unreadable. Please make sure the file exists and that the file permissions to 666 (or the equivalent write permissions for your server) on the following file: expressionengine/config/database.php';
...
$lang['unreadable_language'] = 'The language files needed for your current language selection (%x) are unavailable. Please put the language pack in this folder: expressionengine/languages/';
