...
class Sites extends CP_Controller {
	...
	function update_site()
	{
		...
		{
			$Q = array();
			$Q[] = "INSERT INTO exp_specialty_templates(site_id, template_name, template_type, edit_date, data_title, template_data) VALUES ('".$this->db->escape_str($site_id)."', 'offline_template', 'system', " . time() . "'', '".addslashes(offline_template())."')";
			...
			$Q[] = "INSERT INTO exp_specialty_templates(site_id, template_name, template_type, template_subtype, edit_date, data_title, template_data) VALUES ('".$this->db->escape_str($site_id)."', 'pm_inbox_full', 'email', 'private_messages', " . time() . ", '".addslashes(trim(pm_inbox_full_title()))."', '".addslashes(pm_inbox_full())."')";
