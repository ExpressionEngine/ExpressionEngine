...
class Content_edit extends Controller {
	...
	{		
		...
		$this->javascript->output(array(
			$this->javascript->hide(".paginationLinks .first"), 
			$this->javascript->hide(".paginationLinks .previous")
		));
		...
		$this->javascript->change("#date_range", "
...
function fnDataTablesPipeline ( sSource, aoData, fnCallback ) {
	...
	oTable = $(".mainTable").dataTable( {	
		...
		"oLanguage": {
			"sZeroRecords": "'.$this->lang->line('no_entries_matching_that_criteria').'",
...
*/
	...
	function filtering_menus()
	{
		...
		$channel_info = $this->javascript->generate_json($channel_info, TRUE);
