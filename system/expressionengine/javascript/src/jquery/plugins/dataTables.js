	...
	_oExt.oPagination = {
		...
		"full_numbers": {
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				$(nStatic[0])[ (iCurrentPage < 4)			 ? 'hide' : 'show' ]();		// first 3 pages, no "first" link
				$(nStatic[1])[ (iCurrentPage == 1)			 ? 'hide' : 'show' ]();     // first page, no "previous" link
				$(nStatic[2])[ (iCurrentPage == iPages)		 ? 'hide' : 'show' ]();     // last page, no "next" link
				$(nStatic[3])[ (iCurrentPage > (iPages - 3)) ? 'hide' : 'show' ]();     // last 3 pages, no "last" link
/*
				nStatic[0].className = (iCurrentPage < 4)				? "button_hide" : "paginate_first";
				nStatic[1].className = (iCurrentPage == 1)				? "button_hide" : "paginate_previous";
				nStatic[2].className = (iCurrentPage == iPages)			? "button_hide" : "paginate_next";
				nStatic[3].className = (iCurrentPage > (iPages - 3))	? "button_hide" : "paginate_last";
	...
	$.fn.dataTable = function( oInit )
	{
		...
		{
			return document.getElementById("filter_ajax_indicator");
			...
			//oSettings.nTable.parentNode.insertAfter('#filter_member_submit');			
