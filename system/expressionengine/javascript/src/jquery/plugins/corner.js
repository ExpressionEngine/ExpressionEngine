...
$.fn.corner = function(options) {
	...
	/* Reduced var usage - pk */
    return this.each(function(index){
		var $this = $(this),
			o = (options || $this.attr(corner_defaults.metaAttr) || '').toLowerCase(),
		...
		if (corner_defaults.useNative && fx == 'round' && (moz || webkit) && !cc && !sc) {
			if (opts.TL)
        ...
        for (var j in edges) {
            ...
            if ((bot && (opts.BL || opts.BR)) || (!bot && (opts.TL || opts.TR))) {
				...
				// this won't work on input elements and others that cannot be appended
				// to.  Throws an error in IE - so we skip it!
				if (this.tagName == 'INPUT') continue;
...
$.fn.uncorner = function() { 
	...
	this.children('div.jquery-corner').remove();
	return this;
};

// changed for EE - don't need it to be public - breaks js profiling
var corner_defaults = {
