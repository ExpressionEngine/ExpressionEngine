...
e=f};m=function(){var a;a=d.onStart(e,d.data)||{};c.extend(b.data,a);b.form.attr("action",n());l()};n=function(){return d.url+"&frame_id="+b.iframe.attr("id")+"&"+jQuery.param(b.data)};o=function(){b.iframe.remove();b.form.remove();h()};i=function(a){if(!jQuery.data(b.iframe,"upload_complete"))if((a.contentDocument?a.contentDocument:a.contentWindow?a.contentWindow.document:window.frames[b.iframe.attr("id")].document).location.href!=="about:blank"){window.EE_uploads[b.iframe.attr("id")]?d.onComplete(window.EE_uploads[b.iframe.attr("id")],
e,d.data):d.onFailure("Connection timed out. Please try again.",e,d.data);jQuery.data(b.iframe,"upload_complete",true);setTimeout(function(){o()},0)}};h()})}})(jQuery);
