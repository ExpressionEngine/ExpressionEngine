...
class Template_model extends CI_Model {
	...
	function get_specialty_template_vars($template_name)
	{
		$vars = array(
						...
						'admin_notify_comment'					=> array('weblog_name', 'entry_title', 'comment_url', 'comment', 'comment_id', 'name', 'url', 'email', 'location', 'unwrap}{delete_link}{/unwrap'),
						'admin_notify_trackback'				=> array('entry_title', 'comment_url', 'sending_weblog_name', 'sending_entry_title', 'sending_weblog_url', 'trackback_id', 'unwrap}{delete_link}{/unwrap'),
