...
class Design_model extends CI_Model {
	...
	{
		$this->db->select(array('t.template_id', 't.group_id', 't.template_name', 't.template_type', 't.cache', 't.refresh', 't.no_auth_bounce', 't.enable_http_auth', 't.route', 't.route_required', 't.allow_php', 't.php_parse_location', 't.hits', 'tg.group_name'));
