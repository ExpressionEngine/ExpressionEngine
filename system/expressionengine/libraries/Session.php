...
class EE_Session {
	...
	function EE_Session()
	{
		...
		$this->userdata = array(
								...
								'daylight_savings'  => ($this->EE->config->item('default_site_timezone') != '') ? $this->EE->config->item('default_site_dst') : $this->EE->config->item('daylight_savings'),
								'time_format'		=> 'us',
								'group_id'			=> '3',
								'access_cp'			=>  0,
								'last_visit'		=>  0,
	...
	function fetch_member_data()
	{
		...
		if ($this->EE->config->item('allow_member_localization') == 'n')
		{
			$this->userdata['timezone'] = ($this->EE->config->item('default_site_timezone') != '') ? $this->EE->config->item('default_site_timezone') : $this->EE->config->item('server_timezone');
				$this->userdata['daylight_savings'] = ($this->EE->config->item('default_site_timezone') != '') ? $this->EE->config->item('default_site_dst') : $this->EE->config->item('daylight_savings');
 		}
