...
<div id="templateEditor" class="formArea">
	...
	<div id="template_create">
		<?=form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=forum'.AMP.'method=update_template', '', array('path' => $path))?>
		<p>
...
/* Location: ./system/expressionengine/modules/forum/views/edit_template.php */