...
// @ee - need this
import com.ellislab.ee2.PrepComments;
...
public class YUICompressor {
    ...
    public static void main(String args[]) {
		...
		PrepComments eePrep = new PrepComments();
        ...
        try {
            ...
            if (fileArgs.length == 0) {
				...
				// @ee - using our own file handle
				// in = new InputStreamReader(System.in, charset);
	            
				in = eePrep.get_ee2_file_handle(System.in, charset);
				...
				in = eePrep.get_ee2_file_handle(inputFilename, charset);
            }
            ...
            if (type.equalsIgnoreCase("js")) {
                ...
                try {
					...
					// @ee Shove the comment into the output stream
					out.write(eePrep.getComment());
