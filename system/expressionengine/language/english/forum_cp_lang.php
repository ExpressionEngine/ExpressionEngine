...
'A username or member group is required',
...
'forum_new_install_msg' =>
'To get started with the forum module, you must first create a forum board.',
...
'config_not_writable' =>
'Your config.php file does not appear to be writable.  Please set the file permissions to 666',
...
'The forum board short name you submitted may only contain alpha-numeric characters, underscores, and dashes',
...
'forum_board_prefs_default' =>
'Board Default Preferences',

'forum_board_prefs_default_inst' =>
'These preferences are applied to new forums/categories you create on this board.',
