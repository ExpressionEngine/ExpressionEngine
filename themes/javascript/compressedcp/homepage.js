...
$(document).ready(function(){var e={},f=$('<div id="ajaxContent" />'),b,a,c,d;e[EE.lang.close]=function(){$(this).dialog("close")};f.dialog({autoOpen:!1,resizable:!1,modal:!0,position:"center",minHeight:"0",buttons:e});EE.importantMessage&&(b=EE.importantMessage.state,a=$("#ee_important_message"),c=function(){b=!b;document.cookie="exp_home_msg_state="+(b?"open":"closed")},d=function(){$.ee_notice.show_info(function(){$.ee_notice.hide_info();a.removeClass("closed").show();c()})},a.find(".msg_open_close").click(function(){a.hide();
