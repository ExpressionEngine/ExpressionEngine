...
EE.file_manager=EE.file_manager||{};EE.file_manager.sync_files=EE.file_manager.sync_files||{};EE.file_manager.sync_db=0;EE.file_manager.sync_running=0;EE.file_manager.sync_errors=[];EE.file_manager.resize_ids=[];$(document).ready(function(){$.template("sync_complete_template",$("<div />").append($("#sync_complete_template").remove()));EE.file_manager.sync_listen()});
...
1;EE.file_manager.sync(a);var c=EE.file_manager.sync_file_count;EE.file_manager.update_progress(Math.round((c-EE.file_manager.sync_files.length)/c*100));EE.file_manager.finish_sync(a)},success:function(c){if(c.message_type=="failure")for(var d in c.errors)EE.file_manager.sync_errors.push("<b>"+d+"</b>: "+c.errors[d])}})};EE.file_manager.get_directory_name=function(a){return $("#sync table:first tr[data-id="+a+"] td:first").text()};
