...
EE.file_manager.sync_files.length)/c*100));EE.file_manager.finish_sync(a)},success:function(c){if(c.message_type=="failure")for(var d in c.errors)EE.file_manager.sync_errors.push("<b>"+d+"</b>: "+c.errors[d])}})}};EE.file_manager.get_directory_name=function(a){return $("#sync table:first tr[data-id="+a+"] td:first").text()};
