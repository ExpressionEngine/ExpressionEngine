...
EE.file_manager.sync_listen=function(){$(".tableSubmit input").click(function(a){a.preventDefault();$(this).hide();EE.file_manager.update_progress();EE.file_manager.sync_files=_.toArray(EE.file_manager.sync_files);var b=_.keys(EE.file_manager.sync_sizes)[0];EE.file_manager.update_progress(0);for(a=0;2>a;a++)setTimeout(function(){EE.file_manager.sync(b)},15)})};EE.file_manager.resize_ids=function(){var a=[];$('input[name="toggle[]"]:checked').each(function(){a.push($(this).val())});return a};
...
1;EE.file_manager.sync(a);var c=EE.file_manager.sync_file_count;EE.file_manager.update_progress(Math.round(100*((c-EE.file_manager.sync_files.length)/c)));EE.file_manager.finish_sync(a)},success:function(a,b,c){if("failure"==a.message_type)for(var d in a.errors)EE.file_manager.sync_errors.push("<b>"+d+"</b>: "+a.errors[d])}})};EE.file_manager.get_directory_name=function(a){return $("#sync table:first tr[data-id="+a+"] td:first").text()};
