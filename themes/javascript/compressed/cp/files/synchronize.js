...
1;EE.file_manager.sync(a);var c=EE.file_manager.sync_file_count;EE.file_manager.update_progress(Math.round(100*((c-EE.file_manager.sync_files.length)/c)));EE.file_manager.finish_sync(a)},success:function(a){if("failure"==a.message_type)for(var b in a.errors)EE.file_manager.sync_errors.push("<b>"+b+"</b>: "+a.errors[b])}})};EE.file_manager.get_directory_name=function(a){return $("#sync table:first tr[data-id="+a+"] td:first").text()};
