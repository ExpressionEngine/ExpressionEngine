...
EE.file_manager=EE.file_manager||{};EE.file_manager.sync_files=EE.file_manager.sync_files||{};EE.file_manager.sync_running=0;EE.file_manager.sync_errors=[];$(document).ready(function(){$.template("sync_complete_template",$("<div />").append($("#sync_complete_template").remove()));EE.file_manager.sync_listen()});
