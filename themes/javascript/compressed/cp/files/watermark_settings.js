...
$(document).ready(function(){$.ee_watermark()});$.ee_watermark=function(){$('input[name="wm_type"]:checked').val()=="text"?$(".image_type").hide():$(".text_type").hide();$.ee_watermark.type_toggle()};$.ee_watermark.type_toggle=function(){$("input[name=wm_type]").change(function(){$(".text_type").toggle();$(".image_type").toggle()})};
