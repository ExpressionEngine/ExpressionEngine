...
(function(d){function k(c){var a=!1;return c?(c=c.toString(),c=c.replace(/\(\!\(([\s\S]*?)\)\!\)/g,function(b,c){var a=c.split("|!|");return!0===altKey?void 0!==a[1]?a[1]:a[0]:void 0===a[1]?"":a[0]}),c=c.replace(/\[\!\[([\s\S]*?)\]\!\]/g,function(b,c){var d=c.split(":!:");if(!0===a)return!1;value=prompt(d[0],d[1]?d[1]:"");null===value&&(a=!0);return value})):""}function l(c,a){var b=d("input[name='"+a+"']").closest(".file_field");!1==c.is_image?b.find(".file_set").show().find(".filename").html('<img src="'+
EE.PATH_CP_GBL_IMG+'default.png" alt="'+EE.PATH_CP_GBL_IMG+'default.png" /><br />'+c.file_name):b.find(".file_set").show().find(".filename").html('<img src="'+c.thumb+'" /><br />'+c.file_name);b.find(".choose_file").hide();b.find(".undo_remove").hide();b.find('input[name*="_hidden_file"]').val(c.file_name);b.find('input[name*="_hidden_dir"], select[name*="_directory"]').val(c.upload_location_id)}function i(c,a){d(c,a).each(function(){var b=d(this).closest(".file_field"),a=b.find(".choose_file"),c=
b.find(".no_file"),e=d(this).data("content-type"),f=d(this).data("directory"),j=[],e={content_type:e,directory:f};d.ee_filebrowser.add_trigger(a,d(this).attr("name"),e,l);fileselector=a.length?a:c;b.find(".remove_file").click(function(){b.find("input[type=hidden]").val(function(a,b){j[a]=b;return""});b.find(".file_set").hide();b.find(".sub_filename a").show();fileselector.show();return!1});b.find(".undo_remove").click(function(){b.find("input[type=hidden]").val(function(a){return j.length?j[a]:""});
...
(b.is(".markItUpEditor")||(b.markItUp(myNobuttonSettings),b.closest(".markItUpContainer").find(".markItUpHeader").hide(),b.focus()),a.is_image?d.markItUp({replaceWith:g}):d.markItUp({key:"L",name:"Link",openWith:e,closeWith:f,placeHolder:a.file_name})):b.val(function(a,b){b+=e+g+f;return k(b)})})};EE.publish.file_browser.file_field=function(){i("input[type=file]","#publishForm .publish_file, .pageContents");Grid.bind("file","display",function(c){i("input[type=file]",c)})};EE.publish.file_browser.category_edit_modal=
function(){i("input[type=file]","#cat_modal_container")};d(function(){EE.filebrowser.publish&&setTimeout(function(){EE.publish.file_browser.file_field();EE.publish.file_browser.textarea()},15)})})(jQuery);
