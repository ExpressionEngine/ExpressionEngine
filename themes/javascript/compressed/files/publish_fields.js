...
d(this).attr("name"),c,j);a.find(".remove_file").click(function(){a.find("input[type=hidden]").val("");a.find(".file_set").hide();return!1})})}EE.publish.file_browser.textarea=function(){d.ee_filebrowser.add_trigger(".btn_img a, .file_manipulate",function(a){var b,e="",g="",c="",f="";textareaId=d(this).closest("#markItUpWrite_mode_textarea").length?"write_mode_textarea":d(this).closest(".publish_field").attr("id").replace("hold_field_","field_id_");textareaId!=void 0&&(b=d("#"+textareaId),b.focus());
