...
(function(d){function i(a){var b=!1;return a?(a=a.toString(),a=a.replace(/\(\!\(([\s\S]*?)\)\!\)/g,function(a,b){var c=b.split("|!|");return altKey===!0?c[1]!==void 0?c[1]:c[0]:c[1]===void 0?"":c[0]}),a=a.replace(/\[\!\[([\s\S]*?)\]\!\]/g,function(a,d){var c=d.split(":!:");if(b===!0)return!1;value=prompt(c[0],c[1]?c[1]:"");value===null&&(b=!0);return value})):""}function j(a,b){var e=d("input[name="+b+"]").parent().parent().parent();a.is_image==!1?e.find(".file_set").show().find(".filename").html('<img src="'+
...
directory:f};d.ee_filebrowser.add_trigger(b,d(this).attr("name"),c,j);a.find(".remove_file").click(function(){a.find("input[type=hidden]").val("");a.find(".file_set").hide();return!1})})}EE.publish.file_browser.textarea=function(){d.ee_filebrowser.add_trigger(".btn_img a, .file_manipulate",function(a){var b,e="",g="",c="",f="";textareaId=d(this).closest("#markItUpWrite_mode_textarea").length?"write_mode_textarea":d(this).closest(".publish_field").attr("id").replace("hold_field_","field_id_");textareaId!=
void 0&&(b=d("#"+textareaId),b.focus());a.is_image?(g=EE.upload_directories[a.upload_location_id].properties,c=EE.upload_directories[a.upload_location_id].pre_format,f=EE.upload_directories[a.upload_location_id].post_format,e=EE.filebrowser.image_tag.replace(/src="(.*)\[!\[Link:!:http:\/\/\]!\](.*)"/,'src="$1{filedir_'+a.upload_location_id+"}"+a.file_name+'$2"'),dimensions="",typeof a.file_hw_original!="undefined"&&a.file_hw_original!=""&&(dimensions=a.file_hw_original.split(" "),dimensions='height="'+
...
b.focus()),a.is_image?d.markItUp({replaceWith:e}):d.markItUp({key:"L",name:"Link",openWith:c,closeWith:f,placeHolder:a.file_name})):b.val(function(a,b){b+=c+e+f;return i(b)})})};EE.publish.file_browser.file_field=function(){h("input[type=file]","#publishForm, .pageContents")};EE.publish.file_browser.category_edit_modal=function(){h("input[type=file]","#cat_modal_container")};d(function(){EE.filebrowser.publish==!0&&setTimeout(function(){EE.publish.file_browser.file_field();EE.publish.file_browser.textarea()},
15)})})(jQuery);
