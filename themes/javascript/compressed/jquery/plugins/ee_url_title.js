...
d<128?f+=a.charAt(b):d in EE.publish.foreignChars&&(f+=EE.publish.foreignChars[d]);a=f.replace("/<(.*?)>/g","");a=a.replace(/\s+/g,c);a=a.replace(/\//g,c);a=a.replace(/[^a-z0-9\-\._]/g,"");a=a.replace(/\+/g,c);a=a.replace(h,c);a=a.replace(/^[\-\_]|[\-\_]$/g,"");a=a.replace(/\.+$/g,"");console.log(a);g&&g.val(a.substring(0,75))})}})(jQuery);
