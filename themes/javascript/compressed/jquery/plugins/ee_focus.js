...
(function(b){function g(a,c,d){var e=a.parent,g=this;d.removeTabs&&e.find(d.removeTabs).attr("tabIndex",-1);a.children.attr("tabIndex",-1).eq(0).attr("tabIndex",0);e.bind("keydown",function(a){36<a.keyCode&&41>a.keyCode&&a.preventDefault();if(f[a.keyCode]){var c=d[f[a.keyCode]].call(g,a);!0===c&&b(a.target).trigger("click");return c}});b.extend(this,{getElements:function(){return a},getSelectors:function(){return c},getOptions:function(){return d},setFocus:function(a){b("."+d.focusClass).removeClass(d.focusClass);
