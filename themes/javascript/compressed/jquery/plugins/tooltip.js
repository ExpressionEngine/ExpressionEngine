...
s=a.attr("type"),k=b.events[s]||b.events[r?n?"widget":"input":"def"];if(!q)throw'Nonexistent effect "'+b.effect+'"';k=k.split(/,\s*/);if(2!=k.length)throw"Tooltip: bad events configuration for "+s;a.bind(k[0],function(a){b.predelay?(clearTimeout(f),i=setTimeout(function(){c.show(a)},b.predelay)):c.show(a)}).bind(k[1],function(a){b.delay?(clearTimeout(i),f=setTimeout(function(){c.hide(a)},b.delay)):c.hide(a)});l&&b.cancelDefault&&(a.removeAttr("title"),a.data("title",l));e.extend(c,{show:function(h){if(!d&&
