...
(function(a){function m(){var i=a("#dir_choice"),c=0.95*a(window).width();974<c&&(c=974);d.dialog({width:c,height:615,resizable:!1,position:["center","center"],modal:!0,draggable:!0,title:EE.filebrowser.window_title,autoOpen:!1,zIndex:99999,open:function(){var c=e[f].directory;isNaN(c)||i.val(c);i.trigger("interact");a("#dir_choice").val()},close:function(){a("#keywords",d).val("")}});a("#file_browser_body").find("table").each(function(){b=a(this);if(b.data("table_config"))return!1});c=b.data("table_config");
...
function(b,c,g,h){h?e[c]=g:a.isFunction(c)?(h=c,c="userfile",e[c]={content_type:"any",directory:"all"}):a.isFunction(g)&&(h=g,e[c]={content_type:"any",directory:"all"});a(b).click(function(){if(j)return alert(j),!1;var b=this;f=c;"all"!=e[f].directory?(a("#dir_choice",d).val(e[f].directory),a("#dir_choice_form .dir_choice_container",d).hide()):(a("#dir_choice",d).val(),a("#dir_choice_form .dir_choice_container",d).show());d.dialog("open");k=function(a){h.call(b,a,c)};return!1})};a.ee_filebrowser.get_current_settings=
