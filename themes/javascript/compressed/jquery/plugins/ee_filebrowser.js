...
function(b,c,g,h){h?e[c]=g:a.isFunction(c)?(h=c,c="userfile",e[c]={content_type:"any",directory:"all"}):a.isFunction(g)&&(h=g,e[c]={content_type:"any",directory:"all"});a(b).click(function(){var b=this;f=c;e[f].directory!="all"?(a("#dir_choice",d).val(e[f].directory),a("#dir_choice_form .dir_choice_container",d).hide()):(a("#dir_choice",d).val(),a("#dir_choice_form .dir_choice_container",d).show());d.dialog("open");j=function(a){h.call(b,a,c)};return!1})};a.ee_filebrowser.get_current_settings=function(){return e[f]};
a.ee_filebrowser.placeImage=function(b){a.ee_filebrowser.endpoint_request("file_info",{file_id:b},function(a){j(a);d.dialog("close")});return!1};a.ee_filebrowser.clean_up=function(b){d!=void 0&&(b&&j(b),a("#keywords",d).val(""),d.dialog("close"))};a.ee_filebrowser.reload_directory=function(){a.ee_filebrowser.reload()};a.ee_filebrowser.reload=function(){b&&(b.table("clear_cache"),b.table("refresh"))}})(jQuery);
