...
f),b.table("add_filter",{per_page:15}))});b.bind("tableupdate",function(){"thumb"==a("#view_type").val()&&(a("a.file_browser_thumbnail:nth-child(9n)").addClass("last"),a("a.file_browser_thumbnail:nth-child(9n+1)").addClass("first"),a("a.file_browser_thumbnail:gt(26)").addClass("last_row"))});a("#upload_form",c).submit(a.ee_filebrowser.upload_start);a("#file_browser_body",c).addClass(l)}var c,g="",l="list",j=0,e={},i;a.ee_filebrowser=function(){a.ee_filebrowser.endpoint_request("setup",function(d){dir_files_structure=
...
function(d,b,c){"undefined"==typeof c&&a.isFunction(b)&&(c=b,b={});b=a.extend(b,{action:d});a.ajax({url:EE.BASE+"&"+EE.filebrowser.endpoint_url,type:"GET",dataType:"json",data:b,cache:!1,success:function(a){"function"==typeof c&&c.call(this,a)}})};a.ee_filebrowser.add_trigger=function(d,b,h,f){f?e[b]=h:a.isFunction(b)?(f=b,b="userfile",e[b]={content_type:"any",directory:"all"}):a.isFunction(h)&&(f=h,e[b]={content_type:"any",directory:"all"});a(d).click(function(){var d=this;g=b;"all"!=e[g].directory?
