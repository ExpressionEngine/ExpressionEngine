...
(function(c){c.effects.puff=function(b){return this.queue(function(){var a=c(this),d=c.effects.setMode(a,b.options.mode||"hide"),f=parseInt(b.options.percent,10)||150,i=f/100,g={height:a.height(),width:a.width()};c.extend(b.options,{fade:!0,mode:d,percent:"hide"==d?f:100,from:"hide"==d?g:{height:g.height*i,width:g.width*i}});a.effect("scale",b.options,b.duration,b.callback);a.dequeue()})};c.effects.scale=function(b){return this.queue(function(){var a=c(this),d=c.extend(!0,{},b.options),f=c.effects.setMode(a,
b.options.mode||"effect"),i=parseInt(b.options.percent,10)||(0==parseInt(b.options.percent,10)?0:"hide"==f?0:100),g=b.options.direction||"both",e=b.options.origin;if("effect"!=f)d.origin=e||["middle","center"],d.restore=!0;e={height:a.height(),width:a.width()};a.from=b.options.from||("show"==f?{height:0,width:0}:e);a.to={height:e.height*("horizontal"!=g?i/100:1),width:e.width*("vertical"!=g?i/100:1)};if(b.options.fade){if("show"==f)a.from.opacity=0,a.to.opacity=1;if("hide"==f)a.from.opacity=1,a.to.opacity=
...
b.options.mode||"effect"),q=b.options.restore||!1,n=b.options.scale||"both",k=b.options.origin,h={height:a.height(),width:a.width()};a.from=b.options.from||h;a.to=b.options.to||h;if(k)k=c.effects.getBaseline(k,h),a.from.top=(h.height-a.from.height)*k.y,a.from.left=(h.width-a.from.width)*k.x,a.to.top=(h.height-a.to.height)*k.y,a.to.left=(h.width-a.to.width)*k.x;var l=a.from.height/h.height,o=a.from.width/h.width,m=a.to.height/h.height,p=a.to.width/h.width;if("box"==n||"both"==n){if(l!=m)d=d.concat(e),
a.from=c.effects.setTransition(a,e,l,a.from),a.to=c.effects.setTransition(a,e,m,a.to);if(o!=p)d=d.concat(j),a.from=c.effects.setTransition(a,j,o,a.from),a.to=c.effects.setTransition(a,j,p,a.to)}if(("content"==n||"both"==n)&&l!=m)d=d.concat(g),a.from=c.effects.setTransition(a,g,l,a.from),a.to=c.effects.setTransition(a,g,m,a.to);c.effects.save(a,q?d:f);a.show();c.effects.createWrapper(a);a.css("overflow","hidden").css(a.from);if("content"==n||"both"==n)e=e.concat(["marginTop","marginBottom"]).concat(g),
