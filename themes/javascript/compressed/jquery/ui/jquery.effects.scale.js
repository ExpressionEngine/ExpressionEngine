...
a.from=c.effects.setTransition(a,f,n,a.from),a.to=c.effects.setTransition(a,f,p,a.to)),r!=s&&(d=d.concat(l),a.from=c.effects.setTransition(a,l,r,a.from),a.to=c.effects.setTransition(a,l,s,a.to));if(("content"==q||"both"==q)&&n!=p)d=d.concat(g),a.from=c.effects.setTransition(a,g,n,a.from),a.to=c.effects.setTransition(a,g,p,a.to);c.effects.save(a,t?d:e);a.show();c.effects.createWrapper(a);a.css("overflow","hidden").css(a.from);if("content"==q||"both"==q)f=f.concat(["marginTop","marginBottom"]).concat(g),
