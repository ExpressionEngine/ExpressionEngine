...
this;this.dragged=!0;if(!this.options.disabled){var d=this.options,c=this.opos[0],g=this.opos[1],i=b.pageX,j=b.pageY;if(c>i)var h=i,i=c,c=h;g>j&&(h=j,j=g,g=h);this.helper.css({left:c,top:g,width:i-c,height:j-g});this.selectees.each(function(){var a=e.data(this,"selectable-item");if(a&&a.element!=f.element[0]){var h=!1;"touch"==d.tolerance?h=!(a.left>i||a.right<c||a.top>j||a.bottom<g):"fit"==d.tolerance&&(h=a.left>c&&a.right<i&&a.top>g&&a.bottom<j);if(h){if(a.selected)a.$element.removeClass("ui-selected"),
a.selected=!1;if(a.unselecting)a.$element.removeClass("ui-unselecting"),a.unselecting=!1;if(!a.selecting)a.$element.addClass("ui-selecting"),a.selecting=!0,f._trigger("selecting",b,{selecting:a.element})}else{if(a.selecting)if((b.metaKey||b.ctrlKey)&&a.startselected)a.$element.removeClass("ui-selecting"),a.selecting=!1,a.$element.addClass("ui-selected"),a.selected=!0;else{a.$element.removeClass("ui-selecting");a.selecting=!1;if(a.startselected)a.$element.addClass("ui-unselecting"),a.unselecting=!0;
f._trigger("unselecting",b,{unselecting:a.element})}if(a.selected&&!b.metaKey&&!b.ctrlKey&&!a.startselected)a.$element.removeClass("ui-selected"),a.selected=!1,a.$element.addClass("ui-unselecting"),a.unselecting=!0,f._trigger("unselecting",b,{unselecting:a.element})}}});return!1}},_mouseStop:function(b){var f=this;this.dragged=!1;e(".ui-unselecting",this.element[0]).each(function(){var d=e.data(this,"selectable-item");d.$element.removeClass("ui-unselecting");d.unselecting=!1;d.startselected=!1;f._trigger("unselected",
b,{unselected:d.element})});e(".ui-selecting",this.element[0]).each(function(){var d=e.data(this,"selectable-item");d.$element.removeClass("ui-selecting").addClass("ui-selected");d.selecting=!1;d.selected=!0;d.startselected=!0;f._trigger("selected",b,{selected:d.element})});this._trigger("stop",b);this.helper.remove();return!1}});e.extend(e.ui.selectable,{version:"@VERSION"})})(jQuery);
