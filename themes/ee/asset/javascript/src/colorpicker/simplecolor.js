  ...
  _createClass(SimpleColor, [{
    ...
    value: function shade(percent) {
      return new SimpleColor({
        r: this._rgba.r + percent / 100,
        g: this._rgba.g + percent / 100,
        b: this._rgba.b + percent / 100,
        a: this._rgba.a
      });
    }
    ...
    value: function withAlpha(newAlpha) {
      return new SimpleColor(Object.assign({}, this.rgb, {
        a: newAlpha
      }));
    }
    ...
    value: function _safeRGB(rgb) {
      var check = function check(n) {
        if (isNaN(n)) return 1; // Clamp the value
    ...
    get: function get() {
      return {
        r: Math.round(this._rgba.r * 255),
        g: Math.round(this._rgba.g * 255),
        b: Math.round(this._rgba.b * 255),
        a: this._rgba.a
      };
    }
