...
"use strict";
	...
	$.fn.ee_url_title = function (url_title, remove_periods) {
		...
		/**
		 * The link title has been rearranged with Latin Alphabet characters in accordance with SEO rules.
		 * @editby Ferdi Tarakci
		 * @website https://www.ferditarakci.com
		 * @date 5 April 2022
		 * 
		 * @source Exploited dundalek's latinize source
		 * @link https://github.com/dundalek/latinize
		 */
		...
		return this.each(function () {
			...
			if (url_title) {
				...
				// Auto add URL title for Pages plugin
				$('input[name="pages__pages_uri"]').val(newText.substring(0, urlLength)).trigger('change');
			}
		});
	};
}(jQuery));
