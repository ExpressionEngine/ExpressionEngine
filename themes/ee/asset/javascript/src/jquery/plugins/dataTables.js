...
(function($) {
	...
	_oExt.oPagination = {
	     ...
	     *           node:nPaging - the DIV which contains this pagination control
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw )
			{
				...
				$(anStatic[0])[ (iCurrentPage < 4)			 ? 'hide' : 'show' ]();		// first 3 pages, no "first" link
				$(anStatic[1])[ (iCurrentPage == 1)			 ? 'hide' : 'show' ]();     // first page, no "previous" link
				$(anStatic[2])[ (iCurrentPage == iPages)		 ? 'hide' : 'show' ]();     // last page, no "next" link
				$(anStatic[3])[ (iCurrentPage > (iPages - 3)) ? 'hide' : 'show' ]();     // last 3 pages, no "last" link



				/* End Packet Tide edit */
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				else if ( cOption == 'r' && oSettings.oFeatures.bProcessing )
				{
					...
					/* Packet Tide edit - I hard coded the id rather than writing a new node
					*/
					iPushFeature = 0;
					//iPushFeature = 1;
				}
				...
				else if ( cOption == 'p' && oSettings.oFeatures.bPaginate )
				{
					...
					/* Packet Tide edit - I hard coded it
					*/
		...
		{
			// Packet Tide edit
			var nPaginate = document.getElementById("filter_pagination");
		...
		function _fnUpdateInfo ( oSettings )
		{
			...
			// Packet Tide edit - whole startAdjust bit.
			var startAdjust = 1;
			...
			else if ( oSettings.fnRecordsDisplay() == oSettings.fnRecordsTotal() )
			{
				...
				nFirst.innerHTML = oSettings.oLanguage.sInfo.
						replace('_START_',oSettings._iDisplayStart+startAdjust).
		...
		{
			// Packet Tide edit
			var nProcessing = document.getElementById("filter_ajax_indicator");
			return nProcessing;
		...
		function _fnProcessingDisplay ( oSettings, bShow )
		{
			...
			{
				// Packet Tide edit
				var an = document.getElementById("filter_ajax_indicator");  //oSettings.aanFeatures.r;
				for ( var i=0, iLen=an.length ; i<iLen ; i++ )
				{
...
// ExpressionEngine Defaults

$.extend(true, $.fn.dataTableExt, {
	oStdClasses: {
		"sSortAsc": "headerSortUp",
		"sSortDesc": "headerSortDown"
	},
	oPagination: {
