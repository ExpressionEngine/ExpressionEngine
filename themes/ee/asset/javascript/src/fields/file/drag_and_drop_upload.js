...
var DragAndDropUpload = /*#__PURE__*/function (_React$Component) {
  ...
  function DragAndDropUpload(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "hiddenUpload", function (el) {
      ...
      $(_this.dropZone).parents('div[data-file-field-react]').find('.f_open-filepicker').off().on('change', function (e) {
        var files = e.target.files;
        that.handleDroppedFiles(files);
      });
    });
  ...
  _createClass(DragAndDropUpload, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      }, !this.props.showActionButtons && /*#__PURE__*/React.createElement("p", {
      ...
      }, subheading, this.state.directory == 'all' && uploadDirectoriesForDropdown.length > 0 && ':', this.state.directory != 'all' && /*#__PURE__*/React.createElement("b", null, this.getDirectoryName(this.state.directory)), "\xA0", this.state.directory != 'all' && this.props.allowedDirectory != 'all' && checkChildren && checkChildren.children.length > 0 && /*#__PURE__*/React.createElement(DropDownButton, {
        ...
        ignoreChild: false,
        addInput: false
      }), this.state.files.length == 0 && this.props.allowedDirectory == 'all' && uploadDirectoriesForDropdown.length > 0 && /*#__PURE__*/React.createElement(DropDownButton, {
        key: EE.lang.file_dnd_choose_existing,
        action: this.state.directory == 'all',
        center: true,
        keepSelectedState: true,
      ...
      }, this.props.showActionButtons && this.props.allowedDirectory != 'all' && checkChildren && checkChildren.children.length > 0 && /*#__PURE__*/React.createElement("div", {
      ...
      }, EE.lang.file_dnd_upload_new), /*#__PURE__*/React.createElement("label", {
        htmlFor: "f_open-filepicker_id",
        className: "sr-only"
      }, EE.lang.hidden_input), /*#__PURE__*/React.createElement("input", {
        ...
        multiple: "multiple"
      }))), this.props.showActionButtons && this.props.allowedDirectory == 'all' && /*#__PURE__*/React.createElement("div", {
        className: "button-segment"
      }, /*#__PURE__*/React.createElement(DropDownButton, {
        key: EE.lang.file_dnd_choose_existing,
        action: true,
      ...
      }, "Imitation"), /*#__PURE__*/React.createElement("label", {
        htmlFor: "f_open-filepicker_id",
        className: "sr-only"
      }, EE.lang.hidden_input), /*#__PURE__*/React.createElement("input", {
        id: "f_open-filepicker_id",
