    ...
    let listItem = (
      <label className={'checkbox-label'}
        ...
        {props.removable && (
            ...
            <a href="" className="button button--default js-button-delete" onClick={(e) => props.handleRemove(e, props.item)}><span class="sr-only">Remove button</span><i class="fas fa-fw fa-trash-alt"></i></a>
        )}
        </div>
        </div>
      </label>
