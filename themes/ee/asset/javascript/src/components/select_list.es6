  ...
  render () {
    ...
    return (
      <div className={((props.tooMany) ? ' lots-of-checkboxes' : '')}
        ...
        <FieldInputs nested={props.nested} tooMany={props.tooMany} splitForTwo={props.splitForTwo} list={props.items} selectedItems={props.selected} handle={this.handleSelect}  ariaLabel={props.ariaLabel} useVirtualization={useVirtualization} flattenedItems={flattenedItems} virtualizationHeight={props.virtualizationHeight || 400}>
