...
return e?(e=e.toString(),e=e.replace(/\(\!\(([\s\S]*?)\)\!\)/g,function(e,i){var t=i.split("|!|");return altKey===!0?void 0!==t[1]?t[1]:t[0]:void 0===t[1]?"":t[0]}),e=e.replace(/\[\!\[([\s\S]*?)\]\!\]/g,function(e,t){var n=t.split(":!:");return i===!0?!1:(value=prompt(n[0],n[1]?n[1]:""),null===value&&(i=!0),value)})):""}/**
	 ...
	 */
function t(i,t){var n=e("input[name='"+t+"']").closest(".file_field");n.find(".file_set").show().find(".filename").html(0==i.is_image?'<img src="'+EE.PATH_CP_GBL_IMG+'default.png" alt="'+EE.PATH_CP_GBL_IMG+'default.png" /><br />'+i.file_name:'<img src="'+i.thumb+'" /><br />'+i.file_name),n.find(".choose_file").hide(),n.find(".undo_remove").hide(),n.find('input[name*="_hidden_file"]').val(i.file_name),n.find('input[name*="_hidden_dir"], select[name*="_directory"]').val(i.upload_location_id)}/**
...
e(i,n).each(function(){var i=e(this).closest(".file_field"),n=i.find(".choose_file"),o=i.find(".no_file"),l=e(this).data("content-type"),a=e(this).data("directory"),r=[],// used for undo
d={content_type:l,directory:a};e.ee_filebrowser.add_trigger(n,e(this).attr("name"),d,t),fileselector=n.length?n:o,i.find(".remove_file").click(function(){return i.find("input[type=hidden]").val(function(e,i){return r[e]=i,""}),i.find(".file_set").hide(),i.find(".sub_filename a").show(),fileselector.show(),!1}),i.find(".undo_remove").click(function(){return i.find("input[type=hidden]").val(function(e){return r.length?r[e]:""}),i.find(".file_set").show(),i.find(".sub_filename a").hide(),fileselector.hide(),!1})})}/**
	 * Fires up the filebrowser for text areas
	 */
EE.publish.file_browser.textarea=function(t){
// Bind the image html buttons
e.ee_filebrowser.add_trigger(e(".btn_img a, .file_manipulate",t),function(n){var o,l="",a="",r="",d="";button_id=e(this).parent().attr("class").match(/id(\d+)/),null!=button_id&&(button_id=button_id[1]),void 0!==t?(o=e("textarea",t),o.focus()):(
// A bit of working around various textareas, text inputs, tec
textareaId=e(this).closest("#markItUpWrite_mode_textarea").length?"write_mode_textarea":e(this).closest(".publish_field").attr("id").replace("hold_field_","field_id_"),void 0!=textareaId&&(o=e("textarea[name="+textareaId+"], input[name="+textareaId+"]",t),o.focus())),
