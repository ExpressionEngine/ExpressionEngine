...
i.config.headerList[e]=this}),i.config.debug&&(e("Built headers:",n),r($tableHeaders)),$tableHeaders}function f(e){return t.metadata&&t(e).metadata().sorter===!1?!0:!1}function l(t,e){return t.config.headers[e]&&t.config.headers[e].sorter===!1?!0:!1}function h(t){for(var e=t.config.widgets,r=e.length,i=0;r>i;i++)g(e[i]).format(t)}function g(t){for(var e=B.length,r=0;e>r;r++)if(B[r].id.toLowerCase()==t.toLowerCase())return B[r]}function m(t){return i="Number"!=typeof t?"desc"==t.toLowerCase()?1:0:1==t?t:0,i}function p(t,e){for(var r=e.length,i=0;r>i;i++)if(e[i][0]==t)return!0;return!1}function b(e,r,i,n){
