...
t.each(i.isSelectors,function(t,r){n.is[t]=t in i.isNativeState?function(){return n.selectionIsWithin(r)||e.queryCommandState(i.isNativeState[t])}:function(){return n.selectionIsWithin(r)}});
