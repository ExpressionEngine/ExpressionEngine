...
h.effect="size",h.queue=!1,h.complete=i,"effect"!==f&&(h.origin=d||["middle","center"],h.restore=!0),h.from=t.from||("show"===f?{height:0,width:0,outerHeight:0,outerWidth:0}:n),h.to={height:n.height*u.y,width:n.width*u.x,outerHeight:n.outerHeight*u.y,outerWidth:n.outerWidth*u.x},
