 ...
 * @filesource
 */
$(document).ready(function(){function e(){var e=$("ul.tabs a.act").parents("li").eq(0);return $("ul.tabs li").index(e)}function a(e){var a=$(e).parents("fieldset").eq(0);return $("div.tab-open fieldset").index(a)}function t(){$("ul.tabs li a").droppable({accept:"fieldset.sortable",hoverClass:"highlight",tolerance:"pointer",drop:function(a,t){
// Stop the Timeout
clearTimeout(i),
// Open the tab
$(this).trigger("click"),
...
$('<fieldset class="col-group sortable"></fieldset>').append(t.draggable.html()).prependTo($("div.tab-open")),
...
a.after($("<em></em>").append(a.data("required"))),a.parents("fieldset").addClass("invalid");else if(s.test(l)){for(var n=!1,d=0;d<EE.publish_layout.length;d++)EE.publish_layout[d].id==i&&(n=!0);if(n)
...
$("li.hide a, li.unhide a").on("click",function(t){var l=e(),i=a(this);EE.publish_layout[l].fields[i].visible=!EE.publish_layout[l].fields[i].visible,$(this).parents("li").eq(0).toggleClass("hide unhide"),t.preventDefault()}),
