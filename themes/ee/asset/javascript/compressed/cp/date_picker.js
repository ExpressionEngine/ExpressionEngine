$(document).ready(function(){function e(e){return e+="",2==e.length?e:"0"+e}function t(t,a){var i=t.getFullYear(),r=t.getMonth()+1,l=t.getDate(),d=t.getDay(),s=t.getHours(),c=t.getMinutes();s=(s+11)%12+1,
// Suffix
1==l?suffix="st":2==l?suffix="nd":3==l?suffix="rd":suffix="th",
// Calculate day of year
diff=t-new Date(t.getFullYear(),0,0),doy=Math.ceil(diff/864e5)-1,
// Calculate days in this month
2==r?1==new Date(i,1,29).getMonth()?days_in_month=29:days_in_month=28:[4,6,9,11].indexOf(r)>-1?days_in_month=30:days_in_month=31;var o={
// Day
