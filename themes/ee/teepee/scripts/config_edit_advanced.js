...
var settings = {
	...
	// * shiftEnterMode
	skin: { desc: 'The skin to load. It may be the name of the skin folder inside the editor installation path, or the name and the path separated by a comma.', val: 'teepee' },
...
teepee_addSettingRow = function(initialType, initialVal){
