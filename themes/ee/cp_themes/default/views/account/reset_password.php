...
<div class="box snap">
	...
	<?=form_open('C=login'.AMP.'M=reset_password')?>
		<fieldset>
			...
			<?=form_password(array('dir' => 'ltr', 'name' => "password", 'id' => "password", 'maxlength' => 250, 'autocomplete' => 'off'))?>
		</fieldset>
		<fieldset class="last">
			<?=lang('new_password_confirm', 'password_confirm')?>
			<?=form_password(array('dir' => 'ltr', 'name' => "password_confirm", 'id' => "password_confirm", 'maxlength' => 250, 'autocomplete' => 'off'))?>
		</fieldset>
