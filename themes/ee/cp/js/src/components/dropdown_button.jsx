            ...
            <>
                ...
                <div ref={(el) => this.dropdown = el} className="dropdown">
                    ...
                    <div className="dropdown__scroll">
                        {this.props.addInput &&
                            <label htmlFor="f_open-filepicker_id" className="sr-only">Hidden input for file upload</label> && <input id="f_open-filepicker_id" type="file" className="f_open-filepicker" style={{display: 'none'}} data-upload_location_id={''} data-path={''} />
                        }
