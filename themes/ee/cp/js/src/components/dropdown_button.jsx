                ...
                <div ref={(el) => this.dropdown = el} className="dropdown">
                    ...
                    <div className="dropdown__scroll">
                        {this.props.addInput && (
                            ...
                            <input id="f_open-filepicker_id" type="file" className="f_open-filepicker" style={{display: 'none'}} data-upload_location_id={''} data-path={''} multiple={this.props.allowMultipleFiles}/>
                            </>
                        )}
