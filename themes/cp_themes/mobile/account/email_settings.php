...
<ul>
	<li><?=form_input(array('id'=>'email','name'=>'email','class'=>'field','value'=>$email,'maxlength'=>80))?></li>
</ul>
...
<ul>
	<li><?=form_password(array('id'=>'password','name'=>'password','class'=>'password','value'=>'','maxlength'=>32))?></li>
</ul>
<?php endif;?>
<ul>
