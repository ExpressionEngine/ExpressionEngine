...
<div id="home" class="current">
	...
	<?=form_open('C=design'.AMP.'M=global_variables_update')?>
		...
		<?=form_input(array('id'=>'variable_name','name'=>'variable_name','size'=>40,'class'=>'field','value'=>$variable_name))?>				
		</p>
		<p>
		<label for="variable_data"><?=lang('variable_data')?></label><br />
		<?=form_textarea(array('id'=>'variable_data','name'=>'variable_data','cols'=> 40,'rows'=>10,'class'=>'field','value'=>$variable_data))?>
		</p>
