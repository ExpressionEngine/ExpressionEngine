...
<div id="mainContent"<?=$maincontent_state?>>
	...
	<div class="contents">
		...
		<div class="heading">
			<h2><span id="filter_ajax_indicator"><img src="<?=$cp_theme_url?>images/indicator2.gif" /></span><?=lang('view_search_members')?></h2>
		</div>
		...
		<div class="tableFooter">
			...
			if (count($member_action_options) > 0):?>
 			...
 			<?php endif;?>
				...
				<?=form_submit('effect_members', $delete_button_label, 'class="delete"'); ?>
				</div>
