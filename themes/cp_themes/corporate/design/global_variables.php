...
<div id="mainContent"<?=$maincontent_state?>>
	...
	<div class="contents">
		...
		<div class="heading"><h2><?=lang('global_variables')?></h2></div>
			...
			if ($global_variables_count >= 1)
			{
				foreach ($global_variables->result() as $variable)
				{
					$this->table->add_row(
						...
						'<a href="'.BASE.AMP.'C=design'.AMP.'M=global_variables_delete'.AMP.'variable_id='.$variable->variable_id.'"><img src="'.$cp_theme_url.'images/content_custom_tab_delete.gif" alt="'.lang('delete').'" width="19" height="18" /></a>'
					);
				}
			}
			else
...
/* Location: ./themes/cp_themes/corporate/design/global_variables.php */