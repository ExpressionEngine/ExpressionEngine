...
<div id="mainContent"<?=$maincontent_state?>>
	...
	<div class="contents">
		...
		<div class="heading"><h2><?=lang('create_new_template_group')?></h2>
		</div>
		...
		<div class="pageContents">
            ...
            ?>
          <p class="centerSubmit"><?=form_submit('template', lang('submit'), 'class="submit"')?></p>
            <?=form_close()?>
...
/* Location: ./themes/cp_themes/corporate/design/new_template_group.php */