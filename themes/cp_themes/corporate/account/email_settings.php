<?php $this->load->view('account/_account_header');?>
	...
	<div>
		...
		<p>
			...
			<?=form_input(array('id'=>'email','name'=>'email','class'=>'fullfield','value'=>$email,'max_length'=>80))?>
		</p>

		<?php if ($this->session->userdata('group_id') != 1):?>
		<p><em class="notice"><?=lang('existing_password_email')?></em><br />
			<?=form_label(lang('existing_password'), 'password')?>
			<?=form_password(array('id'=>'password','name'=>'password','class'=>'password','value'=>'','max_length'=>32))?>
		</p>
		<?php endif;?>
