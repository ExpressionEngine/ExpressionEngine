...
<div id="mainContent"<?=$maincontent_state?>>
	...
	<div class="contents">
		...
		<div class="pageContents">
			...
			<table id="entries" class="mainTable" cellspacing="0" cellpadding="0" border="0" summary="Edit group Assignments">
			<thead>
				<tr>
			...
			<tbody>
				<tr>
					<td><strong><?=form_label(lang('category_group'), 'category_group')?></strong></td>
					<td><?=form_dropdown('cat_group[]', $cat_group_options, $cat_group, 'id="category_group" multiple="multiple"')?></td>
				</tr>
				<tr>
					<td><strong><?=form_label(lang('status_group'), 'status_group')?></strong></td>
					<td><?=form_dropdown('status_group', $status_group_options, $status_group, 'id="status_group"')?></td>
				</tr>
				<tr>
					<td><strong><?=form_label(lang('field_group'), 'field_group')?></strong></td>
					<td><?=form_dropdown('field_group', $field_group_options, $field_group, 'id="field_group"')?></td>
				</tr>
			</tbody>
			</table>

			<p class="centerSubmit"><?=form_submit('channel_prefs_submit', lang('update'), 'class="submit"')?></p>
