			...
			if (count($custom_fields) > 0)
			{
				foreach ($custom_fields as $field)
				{
					$this->table->add_row(
						...
						$field['field_name'],
						$field['field_type'],
						'<a href="'.BASE.AMP.'C=admin_content'.AMP.'M=field_delete_confirm'.AMP.'field_id='.$field['field_id'].'"><img src="'.$cp_theme_url.'images/content_custom_tab_delete.png" alt="'.lang('delete').'" width="19" height="18" /></a>'
					);
				}
			}
			else
