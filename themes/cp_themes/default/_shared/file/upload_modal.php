<div id="file_uploader" class="pageContents">
	...
	<div class="button_bar ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix upload_step_1">
		<input type="submit" class="submit" name="upload_file" value="<?= lang('upload_file') ?>" id="upload_file" />
		<input type="submit" class="submit" name="choose_file" value="<?= lang('select_file') ?>" id="choose_file" />
	</div>
</div>
