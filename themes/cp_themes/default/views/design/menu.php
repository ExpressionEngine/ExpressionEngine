<div class="col w-4">
	<div class="box sidebar">
		<h2><?=lang('template_groups')?> <a class="btn action" href="<?=cp_url('design/group/new')?>"><?=lang('new')?></a></h2>
		...
		<h2><a href="<?=cp_url('design/snippets')?>"><?=lang('template_partials')?></a> <a class="btn action" href="<?=cp_url('design/snippets/new')?>"><?=lang('new')?></a></h2>
		<h2><a href="<?=cp_url('design/vars')?>"><?=lang('template_variables')?></a> <a class="btn action" href="<?=cp_url('design/vars/new')?>"><?=lang('new')?></a></h2>
