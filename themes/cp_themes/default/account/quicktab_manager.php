<?php $this->load->view('account/_account_header');?>
	...
	<div>
		<h3><?=lang('tab_manager')?></h3>

		<?=form_open('C=myaccount'.AMP.'M=quicktab_update', '', $form_hidden)?>

		<p><?=lang('tab_manager_description')?></p>
		<p class="go_notice"><?=lang('tab_manager_instructions')?></p>
		<p class="go_notice"><?=lang('tab_manager_description_more')?></p>
