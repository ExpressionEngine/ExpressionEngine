	...
	<div class="contents">
		...
		<div class="pageContents">
			...
			<table class="mainTable padTable" border="0" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						<th width="50%"><?=lang('preference')?></th><th><?=lang('setting')?></th></tr>
					</thead>
				<tbody>
				<tr class="even">
				...
				<tr class="odd">
					...
					<td class="inline_labels"><?=lang('text', 'text').NBS.
								...
								form_radio('wm_type', 'image', $type_image, 'id="type_image"');  ?></td>
				</tr>
				...
				<tr class="even">
					...
					<td><?=form_error('wm_x_offset').
						form_input(array(
							...
							'name'	=> 'wm_x_offset',
							'class'	=> 'field',
							'value' => set_value('wm_x_offset', $wm_x_offset))); ?></td>
				</tr>
				...
				<tr class="odd">
					...
					<td><?=form_error('wm_y_offset').
						form_input(array(
							...
							'name'	=> 'wm_y_offset',
							'class'	=> 'field',
							'value' => set_value('wm_y_offset', $wm_y_offset))); ?></td>
				</tr>
				...
				<tr class="even text_type">
					...
					<td><?=form_error('wm_text').
						form_input(array(
							...
							'name'	=> 'wm_text',
							'class'	=> 'field',
							'value' => set_value('wm_text', $wm_text))); ?></td>
				</tr>
				...
				<tr class="odd text_type">
					...
					<td><?=lang('yes', 'wm_use_font_y').NBS.
									...
									form_radio('wm_use_font', 'n', $font_no); ?></td>
				</tr>
				...
				<tr class="odd text_type">
					...
					<td><?=form_error('wm_font_size').
						form_input(array(
							...
							'name'	=> 'wm_font_size',
							'class'	=> 'field',
							'value' => set_value('wm_font_size', $wm_font_size))); ?></td>
				</tr>
				...
				<tr class="even text_type">>
					...
					<td><?=form_error('wm_text_color').
						form_input(array(
							...
							'name'	=> 'wm_text_color',
							'class'	=> 'field',
							'value' => set_value('wm_text_color', $wm_text_color))); ?></td>
				</tr>
				...
				<tr class="odd text_type">>
					...
					<td><?=lang('yes', 'wm_use_drop_shadow_y').NBS.
									...
									form_radio('wm_use_drop_shadow', 'n', $use_drop_shadow_no); ?></td>
				</tr>
				...
				<tr class="odd text_type">>
					...
					<td><?=form_error('wm_shadow_color').
						form_input(array(
							...
							'class'	=> 'field',
							'value' => set_value('wm_shadow_color', $wm_shadow_color))); ?></td>
				</tr>
				...
				<tr class="even image_type">
					...
					<td><?=form_error('wm_image_path').
						form_input(array(
							...
							'name'	=> 'wm_image_path',
							'class'	=> 'field',
							'value' => set_value('wm_image_path', $wm_image_path))); ?></td>
				</tr>
				...
				<tr class="even image_type">
					...
					<td><?=form_error('wm_x_transp').
						form_input(array(
							...
							'name'	=> 'wm_x_transp',
							'class'	=> 'field',
							'value' => set_value('wm_x_transp', $wm_x_transp))); ?></td>
				</tr>
				...
				<tr class="odd image_type">
					...
					<td><?=form_error('wm_y_transp').
						form_input(array(
							...
							'name'	=> 'wm_y_transp',
							'class'	=> 'field',
							'value' => set_value('wm_y_transp', $wm_y_transp))); ?></td>
				</tr>
				...
				<tr class="even">
					...
					<td><?=form_error('wm_test_image_path').
						form_input(array(
							...
							'class'	=> 'field',
							'value' => set_value('wm_test_image_path', $wm_test_image_path))); ?></td>
