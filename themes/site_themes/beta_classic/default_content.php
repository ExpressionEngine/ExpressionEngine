...
$Q[] = "INSERT INTO exp_upload_prefs (name, server_path, url, allowed_types, properties) 
		VALUES ('Main Upload Directory', '".str_replace(SYSDIR.'/', '', FCPATH).'images/'.$this->userdata['upload_folder']."', '".$this->userdata['site_url'].'images/'.$this->userdata['upload_folder']."', 'all', '$props')";		
