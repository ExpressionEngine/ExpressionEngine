...
feature 'CP Log' do
  ...
  it 'can remove all entries', :pregen => true do
    ...
    @page.should have_alert
    @page.alert.text.should eq "Logs Deleted 169 log(s) deleted from Control Panel logs"
  ...
  it 'will paginate phrase search results', :pregen => true do
    @page.generate_data(count: 20, member_id: 2, username: 'johndoe', timestamp_min: 25)
