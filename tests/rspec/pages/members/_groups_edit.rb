class MemberGroupsEdit < SitePrism::Section
  ...
  elements :can_access_files, 'input[name="can_access_files"]'
  elements :file_upload_directories, 'input[name="file_upload_directories[]"]'
  elements :files, 'input[name="files[]"]'

  elements :can_access_members, 'input[name="can_access_members"]'
  elements :can_admin_mbr_groups, 'input[name="can_admin_mbr_groups"]'
  elements :member_group_actions, 'input[name="member_group_actions[]"]'
  elements :member_actions, 'input[name="member_actions[]"]'

  elements :can_access_design, 'input[name="can_access_design"]'
  ...
  elements :can_access_addons, 'input[name="can_access_addons"]'
  ...
  elements :can_access_utilities, 'input[name="can_access_utilities"]'
  elements :access_tools, 'input[name="access_tools[]"]'
  elements :can_access_logs, 'input[name="can_access_logs"]'
  elements :can_access_sys_prefs, 'input[name="can_access_sys_prefs"]'
  elements :can_access_security_settings, 'input[name="can_access_security_settings"]'
end
