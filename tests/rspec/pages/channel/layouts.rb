class ChannelLayouts < ChannelMangerPage
  ...
  element :name_header, 'div.box form table.app-listing tr th:first-child'
  element :member_groups_header, 'div.box form table.app-listing tr th:nth-child(2)'
  element :manage_header, 'div.box form table.app-listing tr th:nth-child(3)'
  element :checkbox_header, 'div.box form table.app-listing tr th:nth-child(4)'

  elements :titles, 'div.box form table.app-listing tr td:first-child'
  elements :member_groups, 'div.box form table.app-listing tr td:nth-child(2)'
  elements :manage_actions, 'div.box form table.app-listing tr td:nth-child(3)'
