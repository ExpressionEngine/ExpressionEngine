class SpamTrap < ControlPanelPage
  ...
  elements :spam_trap, 'div.box form table.app-listing tr'
  element :selected_spam, 'div.box form table.app-listing tr.selected'

  element :content_header, 'div.box form table.app-listing tr th:first-child'
  element :date_header, 'div.box form table.app-listing tr th:nth-child(2)'
  element :ip_header, 'div.box form table.app-listing tr th:nth-child(3)'
  element :type_header, 'div.box form table.app-listing tr th:nth-child(4)'
  ...
  element :check_all, 'div.box form table.app-listing tr th:nth-child(5) input'

  elements :content, 'div.box form table.app-listing tr td:first-child'
  elements :date, 'div.box form table.app-listing tr td:nth-child(2)'
  elements :ip_addresses, 'div.box form table.app-listing tr td:nth-child(3)'
  ...
  def load
    self.open_dev_menu
    click_link 'Add-Ons'
    self.find('table.app-listing tr a', :text => 'Spam').click
  end
