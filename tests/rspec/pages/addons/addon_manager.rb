class AddonManager < ControlPanelPage
  ...
  elements :first_party_addons, first_party_prefix + 'form table.app-listing tbody tr'

  element :first_party_addon_name_header, first_party_prefix + 'form table.app-listing thead tr th:first-child'
  element :first_party_version_header, first_party_prefix + 'form table.app-listing thead tr th:nth-child(2)'
  element :first_party_manage_header, first_party_prefix + 'form table.app-listing thead tr th:nth-child(3)'
  element :first_party_checkbox_header, first_party_prefix + 'form table.app-listing thead tr th:nth-child(4)'

  elements :first_party_addon_names, first_party_prefix + 'form table.app-listing tbody tr td:first-child'
  elements :first_party_versions, first_party_prefix + 'form table.app-listing tbody tr td:nth-child(2)'
  ...
  elements :third_party_addons, third_party_prefix + 'form table.app-listing tbody tr'

  element :third_party_addon_name_header, third_party_prefix + 'form table.app-listing thead tr th:first-child'
  element :third_party_version_header, third_party_prefix + 'form table.app-listing thead tr th:nth-child(2)'
  element :third_party_manage_header, third_party_prefix + 'form table.app-listing thead tr th:nth-child(3)'
  element :third_party_checkbox_header, third_party_prefix + 'form table.app-listing thead tr th:nth-child(4)'

  elements :third_party_addon_names, third_party_prefix + 'form table.app-listing tbody tr td:first-child'
  elements :third_party_versions, third_party_prefix + 'form table.app-listing tbody tr td:nth-child(2)'
