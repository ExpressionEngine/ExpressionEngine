class AddonManager < ControlPanelPage
	...
	# First Party Add-Ons
	first_party_prefix = 'body section.wrap div.col-group:nth-child(2) div.col.w-16.last div.box:first-child '
	...
	# Third Party Add-Ons
	third_party_prefix = 'body section.wrap div.col-group:nth-child(2) div.col.w-16.last div.box:nth-child(2) '
