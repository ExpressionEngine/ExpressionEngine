class CommunicateSent < ControlPanelPage
  ...
  element :email_table, 'div.box div.tbl-ctrls form table.app-listing'
  element :no_results, 'div.box div.tbl-ctrls form table.app-listing tr.no-results'
  element :subject_header, 'div.box div.tbl-ctrls form table.app-listing tr th:first-child'
  element :date_header, 'div.box div.tbl-ctrls form table.app-listing tr th:nth-child(2)'
  element :total_sent_header, 'div.box div.tbl-ctrls form table.app-listing tr th:nth-child(3)'
  elements :rows, 'div.box div.tbl-ctrls form table.app-listing tr'
  elements :subjects, 'div.box div.tbl-ctrls form table.app-listing tr td:first-child'
  elements :dates, 'div.box div.tbl-ctrls form table.app-listing tr td:nth-child(2)'
  elements :total_sents, 'div.box div.tbl-ctrls form table.app-listing tr td:nth-child(3)'
