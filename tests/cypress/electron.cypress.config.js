...
module.exports = defineConfig({
    "e2e": {
        ...
        "specPattern": "cypress/integration/!(updater)/**.electron.js",
        "supportFile": "cypress/support/index.js",
        setupNodeEvents(on, config) {
            
            const Database = require('./cypress/plugins/database');
            ...
            const Filesystem = require('./cypress/plugins/filesystem');
            const fs = new Filesystem;

            const Installer = require('./cypress/plugins/installer');
