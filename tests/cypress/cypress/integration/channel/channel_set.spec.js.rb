...
import ChannelManager from '../../elements/pages/channel/ChannelManager';
...
context('Channel Sets', () => {
            ...
            expected_files = % w(
                ...
                custom_fields / news_image.file channel_set.json
            )
            found_files = []
            ...
            expected_files = % w(
                ...
                custom_fields / youtube_url.text channel_set.json
            )
            found_files = []
            Zip::File.open(path) do |zipfile |
                    zipfile.each do |file |
