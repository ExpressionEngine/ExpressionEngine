...
//should_have_form_errors(page)
    ...
    page.hasError(page.prv_msg_max_chars, $integer_error)
    page.hasErrors()
//should_have_form_errors(page)
    ...
    page.hasError(page.prv_msg_upload_path, $invalid_path)
    page.hasErrors()
//should_have_form_errors(page)
...
//should_have_form_errors(page)
    ...
    page.hasError(page.prv_msg_max_attachments, $integer_error)
    page.hasErrors()
//should_have_form_errors(page)
    ...
    page.hasError(page.prv_msg_attach_maxsize, $integer_error)
    page.hasErrors()
//should_have_form_errors(page)
    ...
    page.hasError(page.prv_msg_attach_total, $integer_error)
    page.hasErrors()
//should_have_form_errors(page)
