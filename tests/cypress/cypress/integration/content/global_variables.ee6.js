...
context('Global Variables', () => {
  ...
  before(function() {
    ...
    it('Check global variables when logged in', () => {
        ...
        cy.get("#avatar_filename").should('contain', "avatar_1_")
        ...
        cy.get("#ip_address").should('have.text', "127.0.0.1")
        ...
        cy.get("#logged_in_avatar_filename").should('contain', "avatar_1_")
        ...
        cy.get("#logged_in_ip_address").should('have.text', "127.0.0.1")
