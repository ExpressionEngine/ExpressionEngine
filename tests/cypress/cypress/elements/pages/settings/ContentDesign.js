...
class ContentDesign extends ControlPanel {
  constructor() {
      ...
      this.elements({
        ...
        'new_posts_clear_caches': 'input[type!=hidden][name=new_posts_clear_caches]', //visible => false
        'enable_sql_caching_toggle': '[data-toggle-for=enable_sql_caching]',
        'enable_sql_caching': 'input[type!=hidden][name=enable_sql_caching]', //visible => false
        'auto_assign_cat_parents_toggle': '[data-toggle-for=auto_assign_cat_parents]',
        'auto_assign_cat_parents': 'input[type!=hidden][name=auto_assign_cat_parents]', //visible => false
        ...
        'enable_emoticons': 'input[type!=hidden][name=enable_emoticons]', //visible => false
