...
class MemberSettings extends ControlPanel {
  constructor() {
      ...
      this.elements({
        ...
        'allow_member_registration': 'input[type!=hidden][name=allow_member_registration]',//visible => false
        'req_mbr_activation': 'input[type!=hidden][name=req_mbr_activation]',
        'require_terms_of_service_toggle': '[data-toggle-for=require_terms_of_service]',
        'require_terms_of_service': 'input[type!=hidden][name=require_terms_of_service]',//visible => false
        'allow_member_localization_toggle': '[data-toggle-for=allow_member_localization]',
        'allow_member_localization': 'input[type!=hidden][name=allow_member_localization]',//visible => false
        ...
        'new_member_notification': 'input[type!=hidden][name=new_member_notification]',//visible => false
