...
class HitTracking extends ControlPanel {
  constructor() {
      ...
      this.elements({
        'enable_online_user_tracking_toggle': 'a[data-toggle-for=enable_online_user_tracking]',
        'enable_online_user_tracking': 'input[name=enable_online_user_tracking]',//: :visible => false
        'enable_hit_tracking_toggle': 'a[data-toggle-for=enable_hit_tracking]',
        'enable_hit_tracking': 'input[name=enable_hit_tracking]',//: :visible => false
        'enable_entry_view_tracking_toggle': 'a[data-toggle-for=enable_entry_view_tracking]',
