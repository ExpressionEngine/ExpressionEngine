...
class AddonManager extends ControlPanel {
    constructor() {
        ...
        this.selectors = Object.assign(this.selectors, {
            ...
            "first_party_addons": first_party_prefix + 'form div.tbl-wrap table tbody tr',
            ...
            "first_party_addon_names": first_party_prefix + 'form div.tbl-wrap table tbody tr td:first-child',
            "first_party_versions": first_party_prefix + 'form div.tbl-wrap table tbody tr td:nth-child(2)',
            "first_party_pagination": first_party_prefix + 'div.paginate',
            "first_party_pages": first_party_prefix + 'div.paginate ul li a',
            "first_party_bulk_action": first_party_prefix + 'form fieldset.tbl-bulk-act select[name="bulk_action"]',
            "first_party_action_submit_button": first_party_prefix + 'form fieldset.tbl-bulk-act button.submit',
            ...
            "third_party_addons": third_party_prefix + 'form div.tbl-wrap table tbody tr',
            ...
            "third_party_addon_names": third_party_prefix + 'form div.tbl-wrap table tbody tr td:first-child',
            "third_party_versions": third_party_prefix + 'form div.tbl-wrap table tbody tr td:nth-child(2)',
            "third_party_pagination": third_party_prefix + 'div.paginate',
            "third_party_pages": third_party_prefix + 'div.paginate ul li a',
            "third_party_bulk_action": third_party_prefix + 'form fieldset.tbl-bulk-act select[name="bulk_action"]',
            "third_party_action_submit_button": third_party_prefix + 'form fieldset.tbl-bulk-act button.submit',
        })
    }
