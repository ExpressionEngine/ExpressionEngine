...
class ChannelMangerPage extends ControlPanel {
    constructor() {
        ...
        this.selectors = Object.assign(this.selectors, {      	
			  ...
			  "sidebar_new_channels_button" : 'div.sidebar h2:first-child a.btn.action',
			  "sidebar_custom_fields" : 'div.sidebar h2:nth-child(2) a:first-child',
			  "sidebar_new_custom_fileds_button" : 'div.sidebar h2:nth-child(2) a.btn.action',
			  "sidebar_field_groups" : 'div.sidebar ul li:first-child a',
			  "sidebar_category_groups" : 'div.sidebar h2:nth-child(4) a:first-child',
			  "sidebar_new_category_groups_button" : 'div.sidebar h2:nth-child(4) a.btn.action',
			  "sidebar_status_grouops" : 'div.sidebar h2:nth-child(5) a:first-child',
			  "sidebar_new_status_grouops_button" : 'div.sidebar h2:nth-child(5) a.btn.action',
			  // Main box elements
